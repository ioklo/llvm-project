...
#undef GET_VT_RANGES
  ...
  LLVM_CODEGENTYPES_ABI void dump() const;
...
#undef GET_VT_ATTR
  ...
  LLVM_CODEGENTYPES_ABI static MVT getVT(Type *Ty, bool HandleUnknown = false);
  ...
  LLVM_CODEGENTYPES_ABI const fltSemantics &getFltSemantics() const;
