...
struct StringTable {
  ...
  /// in the StrTab map.
  LLVM_REMARKS_ABI void serialize(raw_ostream &OS) const;
  ...
  LLVM_REMARKS_ABI std::vector<StringRef> serialize() const;
};
