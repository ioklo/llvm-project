...
class ConstantInt final : public ConstantData {
  ...
  LLVM_CORE_ABI ConstantInt(Type *Ty, const APInt &V);
...
public:
  ...
  LLVM_CORE_ABI static ConstantInt *getTrue(LLVMContext &Context);
  LLVM_CORE_ABI static ConstantInt *getFalse(LLVMContext &Context);
  LLVM_CORE_ABI static ConstantInt *getBool(LLVMContext &Context, bool V);
  LLVM_CORE_ABI static Constant *getTrue(Type *Ty);
  LLVM_CORE_ABI static Constant *getFalse(Type *Ty);
  LLVM_CORE_ABI static Constant *getBool(Type *Ty, bool V);

  /// If Ty is a vector type, return a Constant with a splat of the given
  /// value. Otherwise return a ConstantInt for the given value.
  LLVM_CORE_ABI static Constant *get(Type *Ty, uint64_t V,
                                     bool IsSigned = false);
  ...
  LLVM_CORE_ABI static ConstantInt *get(IntegerType *Ty, uint64_t V,
                                        bool IsSigned = false);
  ...
  LLVM_CORE_ABI static ConstantInt *get(LLVMContext &Context, const APInt &V);

  /// Return a ConstantInt constructed from the string strStart with the given
  /// radix.
  LLVM_CORE_ABI static ConstantInt *get(IntegerType *Ty, StringRef Str,
                                        uint8_t Radix);

  /// If Ty is a vector type, return a Constant with a splat of the given
  /// value. Otherwise return a ConstantInt for the given value.
  LLVM_CORE_ABI static Constant *get(Type *Ty, const APInt &V);
  ...
  LLVM_CORE_ABI static bool isValueValidForType(Type *Ty, uint64_t V);
  LLVM_CORE_ABI static bool isValueValidForType(Type *Ty, int64_t V);
...
class ConstantFP final : public ConstantData {
  ...
  LLVM_CORE_ABI ConstantFP(Type *Ty, const APFloat &V);
  ...
  LLVM_CORE_ABI static ConstantFP *get(LLVMContext &Context, ElementCount EC,
                                       const APFloat &V);
...
public:
  ...
  LLVM_CORE_ABI static Constant *get(Type *Ty, double V);

  /// If Ty is a vector type, return a Constant with a splat of the given
  /// value. Otherwise return a ConstantFP for the given value.
  LLVM_CORE_ABI static Constant *get(Type *Ty, const APFloat &V);

  LLVM_CORE_ABI static Constant *get(Type *Ty, StringRef Str);
  LLVM_CORE_ABI static ConstantFP *get(LLVMContext &Context, const APFloat &V);
  LLVM_CORE_ABI static Constant *getNaN(Type *Ty, bool Negative = false,
                                        uint64_t Payload = 0);
  LLVM_CORE_ABI static Constant *getQNaN(Type *Ty, bool Negative = false,
                                         APInt *Payload = nullptr);
  LLVM_CORE_ABI static Constant *getSNaN(Type *Ty, bool Negative = false,
                                         APInt *Payload = nullptr);
  LLVM_CORE_ABI static Constant *getZero(Type *Ty, bool Negative = false);
  ...
  LLVM_CORE_ABI bool isExactlyValue(const APFloat &V) const;
...
public:
  ...
  LLVM_CORE_ABI static ConstantAggregateZero *get(Type *Ty);

  /// If this CAZ has array or vector type, return a zero with the right element
  /// type.
  LLVM_CORE_ABI Constant *getSequentialElement() const;

  /// If this CAZ has struct type, return a zero with the right element type for
  /// the specified element.
  LLVM_CORE_ABI Constant *getStructElement(unsigned Elt) const;

  /// Return a zero of the right value for the specified GEP index if we can,
  /// otherwise return null (e.g. if C is a ConstantExpr).
  LLVM_CORE_ABI Constant *getElementValue(Constant *C) const;

  /// Return a zero of the right value for the specified GEP index.
  LLVM_CORE_ABI Constant *getElementValue(unsigned Idx) const;

  /// Return the number of elements in the array, vector, or struct.
  LLVM_CORE_ABI ElementCount getElementCount() const;
...
protected:
  LLVM_CORE_ABI ConstantAggregate(Type *T, ValueTy VT, ArrayRef<Constant *> V,
                                  AllocInfo AllocInfo);
...
class ConstantArray final : public ConstantAggregate {
  ...
  LLVM_CORE_ABI ConstantArray(ArrayType *T, ArrayRef<Constant *> Val,
                              AllocInfo AllocInfo);
...
public:
  ...
  LLVM_CORE_ABI static Constant *get(ArrayType *T, ArrayRef<Constant *> V);

private:
  LLVM_CORE_ABI static Constant *getImpl(ArrayType *T, ArrayRef<Constant *> V);
...
class ConstantStruct final : public ConstantAggregate {
  ...
  LLVM_CORE_ABI ConstantStruct(StructType *T, ArrayRef<Constant *> Val,
                               AllocInfo AllocInfo);
...
public:
  ...
  LLVM_CORE_ABI static Constant *get(StructType *T, ArrayRef<Constant *> V);
  ...
  LLVM_CORE_ABI static StructType *getTypeForElements(ArrayRef<Constant *> V,
                                                      bool Packed = false);
  /// This version of the method allows an empty list.
  LLVM_CORE_ABI static StructType *getTypeForElements(LLVMContext &Ctx,
                                                      ArrayRef<Constant *> V,
                                                      bool Packed = false);
...
class ConstantVector final : public ConstantAggregate {
  ...
  LLVM_CORE_ABI ConstantVector(VectorType *T, ArrayRef<Constant *> Val,
                               AllocInfo AllocInfo);
...
public:
  ...
  LLVM_CORE_ABI static Constant *get(ArrayRef<Constant *> V);

private:
  LLVM_CORE_ABI static Constant *getImpl(ArrayRef<Constant *> V);

public:
  /// Return a ConstantVector with the specified constant in each element.
  /// Note that this might not return an instance of ConstantVector
  LLVM_CORE_ABI static Constant *getSplat(ElementCount EC, Constant *Elt);
...
public:
  ...
  LLVM_CORE_ABI static ConstantPointerNull *get(PointerType *T);
...
protected:
  ...
  LLVM_CORE_ABI static Constant *getImpl(StringRef Bytes, Type *Ty);
...
public:
  ...
  LLVM_CORE_ABI static bool isElementTypeCompatible(Type *Ty);

  /// If this is a sequential container of integers (of any size), return the
  /// specified element in the low bits of a uint64_t.
  LLVM_CORE_ABI uint64_t getElementAsInteger(unsigned i) const;

  /// If this is a sequential container of integers (of any size), return the
  /// specified element as an APInt.
  LLVM_CORE_ABI APInt getElementAsAPInt(unsigned i) const;

  /// If this is a sequential container of floating point type, return the
  /// specified element as an APFloat.
  LLVM_CORE_ABI APFloat getElementAsAPFloat(unsigned i) const;

  /// If this is an sequential container of floats, return the specified element
  /// as a float.
  LLVM_CORE_ABI float getElementAsFloat(unsigned i) const;

  /// If this is an sequential container of doubles, return the specified
  /// element as a double.
  LLVM_CORE_ABI double getElementAsDouble(unsigned i) const;

  /// Return a Constant for a specified index's element.
  /// Note that this has to compute a new constant to return, so it isn't as
  /// efficient as getElementAsInteger/Float/Double.
  LLVM_CORE_ABI Constant *getElementAsConstant(unsigned i) const;

  /// Return the element type of the array/vector.
  LLVM_CORE_ABI Type *getElementType() const;

  /// Return the number of elements in the array or vector.
  LLVM_CORE_ABI unsigned getNumElements() const;

  /// Return the size (in bytes) of each element in the array/vector.
  /// The size of the elements is known to be a multiple of one byte.
  LLVM_CORE_ABI uint64_t getElementByteSize() const;

  /// This method returns true if this is an array of \p CharSize integers.
  LLVM_CORE_ABI bool isString(unsigned CharSize = 8) const;

  /// This method returns true if the array "isString", ends with a null byte,
  /// and does not contains any other null bytes.
  LLVM_CORE_ABI bool isCString() const;
  ...
  /// the data elements.
  LLVM_CORE_ABI StringRef getRawDataValues() const;
...
private:
  LLVM_CORE_ABI const char *getElementPointer(unsigned Elt) const;
};
...
public:
  ...
  LLVM_CORE_ABI static Constant *getFP(Type *ElementType,
...
class ConstantDataVector final : public ConstantDataSequential {
  ...
  LLVM_CORE_ABI bool isSplatData() const;
...
public:
  ...
  /// count and element type matching the ArrayRef passed in.  Note that this
  /// can return a ConstantAggregateZero object.
  LLVM_CORE_ABI static Constant *get(LLVMContext &Context,
  ...
  LLVM_CORE_ABI static Constant *getSplat(unsigned NumElts, Constant *Elt);

  /// Returns true if this is a splat constant, meaning that all elements have
  /// the same value.
  LLVM_CORE_ABI bool isSplat() const;

  /// If this is a splat constant, meaning that all of the elements have the
  /// same value, return that value. Otherwise return NULL.
  LLVM_CORE_ABI Constant *getSplatValue() const;
...
public:
  ...
  LLVM_CORE_ABI static ConstantTokenNone *get(LLVMContext &Context);
...
public:
  ...
  /// Static factory methods - Return objects of the specified value.
  LLVM_CORE_ABI static ConstantTargetNone *get(TargetExtType *T);
...
class BlockAddress final : public Constant {
  ...
  LLVM_CORE_ABI BlockAddress(Function *F, BasicBlock *BB);
...
public:
  ...
  LLVM_CORE_ABI static BlockAddress *get(Function *F, BasicBlock *BB);

  /// Return a BlockAddress for the specified basic block.  The basic
  /// block must be embedded into a function.
  LLVM_CORE_ABI static BlockAddress *get(BasicBlock *BB);

  /// Lookup an existing \c BlockAddress constant for the given BasicBlock.
  ///
  /// \returns 0 if \c !BB->hasAddressTaken(), otherwise the \c BlockAddress.
  LLVM_CORE_ABI static BlockAddress *lookup(const BasicBlock *BB);
...
class DSOLocalEquivalent final : public Constant {
  ...
  LLVM_CORE_ABI DSOLocalEquivalent(GlobalValue *GV);
...
public:
  ...
  LLVM_CORE_ABI static DSOLocalEquivalent *get(GlobalValue *GV);
...
class NoCFIValue final : public Constant {
  ...
  LLVM_CORE_ABI NoCFIValue(GlobalValue *GV);
...
public:
  ...
  LLVM_CORE_ABI static NoCFIValue *get(GlobalValue *GV);
...
class ConstantPtrAuth final : public Constant {
  ...
  LLVM_CORE_ABI ConstantPtrAuth(Constant *Ptr, ConstantInt *Key,
...
public:
  ...
  LLVM_CORE_ABI static ConstantPtrAuth *
  get(Constant *Ptr, ConstantInt *Key, ConstantInt *Disc, Constant *AddrDisc);

  /// Produce a new ptrauth expression signing the given value using
  /// the same schema as is stored in one.
  LLVM_CORE_ABI ConstantPtrAuth *getWithSameSchema(Constant *Pointer) const;
  ...
  LLVM_CORE_ABI bool hasSpecialAddressDiscriminator(uint64_t Value) const;
  ...
  LLVM_CORE_ABI bool isKnownCompatibleWith(const Value *Key,
...
public:
  ...
  LLVM_CORE_ABI static Constant *getAlignOf(Type *Ty);

  /// getSizeOf constant expr - computes the (alloc) size of a type (in
  /// address-units, not bits) in a target independent way (Note: the return
  /// type is an i64).
  ///
  LLVM_CORE_ABI static Constant *getSizeOf(Type *Ty);

  LLVM_CORE_ABI static Constant *getNeg(Constant *C, bool HasNSW = false);
  LLVM_CORE_ABI static Constant *getNot(Constant *C);
  LLVM_CORE_ABI static Constant *
  getAdd(Constant *C1, Constant *C2, bool HasNUW = false, bool HasNSW = false);
  LLVM_CORE_ABI static Constant *
  getSub(Constant *C1, Constant *C2, bool HasNUW = false, bool HasNSW = false);
  LLVM_CORE_ABI static Constant *
  getMul(Constant *C1, Constant *C2, bool HasNUW = false, bool HasNSW = false);
  LLVM_CORE_ABI static Constant *getXor(Constant *C1, Constant *C2);
  LLVM_CORE_ABI static Constant *getTrunc(Constant *C, Type *Ty,
                                          bool OnlyIfReduced = false);
  LLVM_CORE_ABI static Constant *getPtrToInt(Constant *C, Type *Ty,
                                             bool OnlyIfReduced = false);
  LLVM_CORE_ABI static Constant *getIntToPtr(Constant *C, Type *Ty,
                                             bool OnlyIfReduced = false);
  LLVM_CORE_ABI static Constant *getBitCast(Constant *C, Type *Ty,
                                            bool OnlyIfReduced = false);
  LLVM_CORE_ABI static Constant *getAddrSpaceCast(Constant *C, Type *Ty,
                                                  bool OnlyIfReduced = false);
  ...
  LLVM_CORE_ABI static Constant *getExactLogBase2(Constant *C);
  ...
  LLVM_CORE_ABI static Constant *getBinOpIdentity(unsigned Opcode, Type *Ty,
                                                  bool AllowRHSConstant = false,
                                                  bool NSZ = false);

  LLVM_CORE_ABI static Constant *getIntrinsicIdentity(Intrinsic::ID, Type *Ty);
  ...
  LLVM_CORE_ABI static Constant *getIdentity(Instruction *I, Type *Ty,
                                             bool AllowRHSConstant = false,
                                             bool NSZ = false);
  ...
  LLVM_CORE_ABI static Constant *
  getBinOpAbsorber(unsigned Opcode, Type *Ty, bool AllowLHSConstant = false);
  ...
  LLVM_CORE_ABI static Constant *getCast(unsigned ops, Constant *C, Type *Ty,
                                         bool OnlyIfReduced = false);
  ...
  /// the address space.
  LLVM_CORE_ABI static Constant *getPointerBitCastOrAddrSpaceCast(
      Constant *C, ///< The constant to addrspacecast or bitcast
      Type *Ty     ///< The type to bitcast or addrspacecast C to
  );

  /// Return true if this is a convert constant expression
  LLVM_CORE_ABI bool isCast() const;

  /// get - Return a binary or shift operator constant expression,
  /// folding if possible.
  ///
  /// \param OnlyIfReducedTy see \a getWithOperands() docs.
  LLVM_CORE_ABI static Constant *get(unsigned Opcode, Constant *C1,
                                     Constant *C2,
  ...
  LLVM_CORE_ABI static Constant *
  getExtractElement(Constant *Vec, Constant *Idx,
                                     Type *OnlyIfReducedTy = nullptr);
  LLVM_CORE_ABI static Constant *
  getInsertElement(Constant *Vec, Constant *Elt, Constant *Idx,
                                    Type *OnlyIfReducedTy = nullptr);
  LLVM_CORE_ABI static Constant *
  getShuffleVector(Constant *V1, Constant *V2,
                                    ArrayRef<int> Mask,
                                    Type *OnlyIfReducedTy = nullptr);
  ...
  LLVM_CORE_ABI ArrayRef<int> getShuffleMask() const;

  /// Assert that this is a shufflevector and return the mask.
  ///
  /// TODO: This is a temporary hack until we update the bitcode format for
  /// shufflevector.
  LLVM_CORE_ABI Constant *getShuffleMaskForBitcode() const;

  /// Return a string representation for an opcode.
  LLVM_CORE_ABI const char *getOpcodeName() const;
  ...
  LLVM_CORE_ABI Constant *getWithOperands(ArrayRef<Constant *> Ops, Type *Ty,
                                          bool OnlyIfReduced = false,
  ...
  LLVM_CORE_ABI Instruction *getAsInstruction() const;

  /// Whether creating a constant expression for this binary operator is
  /// desirable.
  LLVM_CORE_ABI static bool isDesirableBinOp(unsigned Opcode);

  /// Whether creating a constant expression for this binary operator is
  /// supported.
  LLVM_CORE_ABI static bool isSupportedBinOp(unsigned Opcode);

  /// Whether creating a constant expression for this cast is desirable.
  LLVM_CORE_ABI static bool isDesirableCastOp(unsigned Opcode);

  /// Whether creating a constant expression for this cast is supported.
  LLVM_CORE_ABI static bool isSupportedCastOp(unsigned Opcode);
...
public:
  ...
  LLVM_CORE_ABI static UndefValue *get(Type *T);

  /// If this Undef has array or vector type, return a undef with the right
  /// element type.
  LLVM_CORE_ABI UndefValue *getSequentialElement() const;

  /// If this undef has struct type, return a undef with the right element type
  /// for the specified element.
  LLVM_CORE_ABI UndefValue *getStructElement(unsigned Elt) const;

  /// Return an undef of the right value for the specified GEP index if we can,
  /// otherwise return null (e.g. if C is a ConstantExpr).
  LLVM_CORE_ABI UndefValue *getElementValue(Constant *C) const;

  /// Return an undef of the right value for the specified GEP index.
  LLVM_CORE_ABI UndefValue *getElementValue(unsigned Idx) const;
