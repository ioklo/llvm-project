...
class GlobalAlias : public GlobalValue, public ilist_node<GlobalAlias> {
  ...
  LLVM_CORE_ABI GlobalAlias(Type *Ty, unsigned AddressSpace,
...
public:
  ...
  LLVM_CORE_ABI static GlobalAlias *create(Type *Ty, unsigned AddressSpace,
  ...
  LLVM_CORE_ABI static GlobalAlias *
  create(LinkageTypes Linkage, const Twine &Name, GlobalValue *Aliasee);

  // Linkage, Type, Parent and AddressSpace taken from the Aliasee.
  LLVM_CORE_ABI static GlobalAlias *create(const Twine &Name,
                                           GlobalValue *Aliasee);
  ...
  LLVM_CORE_ABI void setAliasee(Constant *Aliasee);
