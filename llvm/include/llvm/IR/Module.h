...
public:
  ...
  LLVM_CORE_ABI static bool isValidModFlagBehavior(Metadata *MD,
                                                   ModFlagBehavior &MFB);
...
public:
  ...
  LLVM_CORE_ABI void removeDebugIntrinsicDeclarations();
  ...
  LLVM_CORE_ABI explicit Module(StringRef ModuleID, LLVMContext &C);
  /// The module destructor. This will dropAllReferences.
  LLVM_CORE_ABI ~Module();

  /// Move assignment.
  LLVM_CORE_ABI Module &operator=(Module &&Other);
  ...
  LLVM_CORE_ABI std::unique_ptr<RandomNumberGenerator>
  createRNG(const StringRef Name) const;
  ...
  /// Set the data layout
  LLVM_CORE_ABI void setDataLayout(StringRef Desc);
  LLVM_CORE_ABI void setDataLayout(const DataLayout &Other);
  ...
  /// name is not found.
  LLVM_CORE_ABI GlobalValue *getNamedValue(StringRef Name) const;

  /// Return the number of global values in the module.
  LLVM_CORE_ABI unsigned getNumNamedValues() const;

  /// Return a unique non-zero ID for the specified metadata kind. This ID is
  /// uniqued across modules in the current LLVMContext.
  LLVM_CORE_ABI unsigned getMDKindID(StringRef Name) const;

  /// Populate client supplied SmallVector with the name for custom metadata IDs
  /// registered in this LLVMContext.
  LLVM_CORE_ABI void getMDKindNames(SmallVectorImpl<StringRef> &Result) const;
  ...
  LLVM_CORE_ABI std::vector<StructType *> getIdentifiedStructTypes() const;
  ...
  LLVM_CORE_ABI std::string getUniqueIntrinsicName(StringRef BaseName,
                                                   Intrinsic::ID Id,
  ...
  LLVM_CORE_ABI FunctionCallee getOrInsertFunction(StringRef Name,
                                                   FunctionType *T,
  ...
  /// Look up the specified function in the module symbol table. If it does not
  /// exist, return null.
  LLVM_CORE_ABI Function *getFunction(StringRef Name) const;
  ...
  LLVM_CORE_ABI GlobalVariable *getGlobalVariable(StringRef Name,
  ...
  LLVM_CORE_ABI Constant *getOrInsertGlobal(StringRef Name, Type *Ty);
  ...
  /// arbitrary type. This method returns null if a global with the specified
  /// name is not found.
  LLVM_CORE_ABI GlobalAlias *getNamedAlias(StringRef Name) const;
  ...
  /// arbitrary type. This method returns null if a global with the specified
  /// name is not found.
  LLVM_CORE_ABI GlobalIFunc *getNamedIFunc(StringRef Name) const;
  ...
  LLVM_CORE_ABI NamedMDNode *getNamedMetadata(StringRef Name) const;
  ...
  /// found.
  LLVM_CORE_ABI NamedMDNode *getOrInsertNamedMetadata(StringRef Name);

  /// Remove the given NamedMDNode from this module and delete it.
  LLVM_CORE_ABI void eraseNamedMetadata(NamedMDNode *NMD);
  ...
  LLVM_CORE_ABI Comdat *getOrInsertComdat(StringRef Name);
  ...
  /// return null.
  LLVM_CORE_ABI Metadata *getModuleFlag(StringRef Key) const;
  ...
  /// contains them.
  LLVM_CORE_ABI NamedMDNode *getOrInsertModuleFlagsMetadata();
  ...
  LLVM_CORE_ABI void addModuleFlag(ModFlagBehavior Behavior, StringRef Key,
                                   Metadata *Val);
  LLVM_CORE_ABI void addModuleFlag(ModFlagBehavior Behavior, StringRef Key,
                                   Constant *Val);
  LLVM_CORE_ABI void addModuleFlag(ModFlagBehavior Behavior, StringRef Key,
                                   uint32_t Val);
  LLVM_CORE_ABI void addModuleFlag(MDNode *Node);
  /// Like addModuleFlag but replaces the old module flag if it already exists.
  LLVM_CORE_ABI void setModuleFlag(ModFlagBehavior Behavior, StringRef Key,
                                   Metadata *Val);
  LLVM_CORE_ABI void setModuleFlag(ModFlagBehavior Behavior, StringRef Key,
                                   Constant *Val);
  LLVM_CORE_ABI void setModuleFlag(ModFlagBehavior Behavior, StringRef Key,
  ...
  /// unmaterialized GVs.
  LLVM_CORE_ABI void setMaterializer(GVMaterializer *GVM);
  /// Retrieves the GVMaterializer, if any, for this Module.
  GVMaterializer *getMaterializer() const { return Materializer.get(); }
  bool isMaterialized() const { return !getMaterializer(); }

  /// Make sure the GlobalValue is fully read.
  LLVM_CORE_ABI llvm::Error materialize(GlobalValue *GV);

  /// Make sure all GlobalValues in this Module are fully read and clear the
  /// Materializer.
  LLVM_CORE_ABI llvm::Error materializeAll();

  LLVM_CORE_ABI llvm::Error materializeMetadata();
...
public:
  ...
  LLVM_CORE_ABI iterator_range<global_object_iterator> global_objects();
  LLVM_CORE_ABI iterator_range<const_global_object_iterator>
  ...
  LLVM_CORE_ABI iterator_range<global_value_iterator> global_values();
  LLVM_CORE_ABI iterator_range<const_global_value_iterator>
  global_values() const;
  ...
  class debug_compile_units_iterator {
    ...
    LLVM_CORE_ABI void SkipNoDebugCUs();
  ...
  public:
    ...
    LLVM_CORE_ABI DICompileUnit *operator*() const;
    LLVM_CORE_ABI DICompileUnit *operator->() const;
  };
  ...
  LLVM_CORE_ABI void dropTriviallyDeadConstantArrays();
  ...
  /// the assembly.
  LLVM_CORE_ABI void print(raw_ostream &OS, AssemblyAnnotationWriter *AAW,
  ...
  /// module flags.
  LLVM_CORE_ABI unsigned getNumberRegisterParameters() const;

  /// Returns the Dwarf Version by checking module flags.
  LLVM_CORE_ABI unsigned getDwarfVersion() const;

  /// Returns the DWARF format by checking module flags.
  LLVM_CORE_ABI bool isDwarf64() const;

  /// Returns the CodeView Version by checking module flags.
  /// Returns zero if not present in module.
  LLVM_CORE_ABI unsigned getCodeViewFlag() const;
  ...
  LLVM_CORE_ABI PICLevel::Level getPICLevel() const;

  /// Set the PIC level (small or large model)
  LLVM_CORE_ABI void setPICLevel(PICLevel::Level PL);
  /// @}
  ...
  LLVM_CORE_ABI PIELevel::Level getPIELevel() const;

  /// Set the PIE level (small or large model)
  LLVM_CORE_ABI void setPIELevel(PIELevel::Level PL);
  /// @}
  ...
  LLVM_CORE_ABI std::optional<CodeModel::Model> getCodeModel() const;

  /// Set the code model (tiny, small, kernel, medium or large)
  LLVM_CORE_ABI void setCodeModel(CodeModel::Model CL);
  /// @}
  ...
  /// Returns the code model (tiny, small, kernel, medium or large model)
  LLVM_CORE_ABI std::optional<uint64_t> getLargeDataThreshold() const;

  /// Set the code model (tiny, small, kernel, medium or large)
  LLVM_CORE_ABI void setLargeDataThreshold(uint64_t Threshold);
  /// @}
  ...
  LLVM_CORE_ABI void setProfileSummary(Metadata *M, ProfileSummary::Kind Kind);

  /// Returns profile summary metadata. When IsCS is true, use the context
  /// sensitive profile summary.
  LLVM_CORE_ABI Metadata *getProfileSummary(bool IsCS) const;
  /// @}

  /// Returns whether semantic interposition is to be respected.
  LLVM_CORE_ABI bool getSemanticInterposition() const;

  /// Set whether semantic interposition is to be respected.
  LLVM_CORE_ABI void setSemanticInterposition(bool);

  /// Returns true if PLT should be avoided for RTLib calls.
  LLVM_CORE_ABI bool getRtLibUseGOT() const;

  /// Set that PLT should be avoid for RTLib calls.
  LLVM_CORE_ABI void setRtLibUseGOT();

  /// Get/set whether referencing global variables can use direct access
  /// relocations on ELF targets.
  LLVM_CORE_ABI bool getDirectAccessExternalData() const;
  LLVM_CORE_ABI void setDirectAccessExternalData(bool Value);

  /// Get/set whether synthesized functions should get the uwtable attribute.
  LLVM_CORE_ABI UWTableKind getUwtable() const;
  LLVM_CORE_ABI void setUwtable(UWTableKind Kind);

  /// Get/set whether synthesized functions should get the "frame-pointer"
  /// attribute.
  LLVM_CORE_ABI FramePointerKind getFramePointer() const;
  LLVM_CORE_ABI void setFramePointer(FramePointerKind Kind);

  /// Get/set what kind of stack protector guard to use.
  LLVM_CORE_ABI StringRef getStackProtectorGuard() const;
  LLVM_CORE_ABI void setStackProtectorGuard(StringRef Kind);
  ...
  /// "sysreg".
  LLVM_CORE_ABI StringRef getStackProtectorGuardReg() const;
  LLVM_CORE_ABI void setStackProtectorGuardReg(StringRef Reg);

  /// Get/set a symbol to use as the stack protector guard.
  LLVM_CORE_ABI StringRef getStackProtectorGuardSymbol() const;
  LLVM_CORE_ABI void setStackProtectorGuardSymbol(StringRef Symbol);

  /// Get/set what offset from the stack protector to use.
  LLVM_CORE_ABI int getStackProtectorGuardOffset() const;
  LLVM_CORE_ABI void setStackProtectorGuardOffset(int Offset);

  /// Get/set the stack alignment overridden from the default.
  LLVM_CORE_ABI unsigned getOverrideStackAlignment() const;
  LLVM_CORE_ABI void setOverrideStackAlignment(unsigned Align);

  LLVM_CORE_ABI unsigned getMaxTLSAlignment() const;

  /// @name Utility functions for querying and setting the build SDK version
  /// @{

  /// Attach a build SDK version metadata to this module.
  LLVM_CORE_ABI void setSDKVersion(const VersionTuple &V);

  /// Get the build SDK version metadata.
  ///
  /// An empty version is returned if no such metadata is attached.
  LLVM_CORE_ABI VersionTuple getSDKVersion() const;
  /// @}

  /// Take ownership of the given memory buffer.
  LLVM_CORE_ABI void setOwnedMemoryBuffer(std::unique_ptr<MemoryBuffer> MB);

  /// Set the partial sample profile ratio in the profile summary module flag,
  /// if applicable.
  LLVM_CORE_ABI void
  setPartialSampleProfileRatio(const ModuleSummaryIndex &Index);
  ...
  LLVM_CORE_ABI StringRef getDarwinTargetVariantTriple() const;

  /// Set the target variant triple which is a string describing a variant of
  /// the target host platform.
  LLVM_CORE_ABI void setDarwinTargetVariantTriple(StringRef T);

  /// Get the target variant version build SDK version metadata.
  ///
  /// An empty version is returned if no such metadata is attached.
  LLVM_CORE_ABI VersionTuple getDarwinTargetVariantSDKVersion() const;

  /// Set the target variant version build SDK version metadata.
  LLVM_CORE_ABI void setDarwinTargetVariantSDKVersion(VersionTuple Version);
};

/// Given "llvm.used" or "llvm.compiler.used" as a global name, collect the
/// initializer elements of that global in a SmallVector and return the global
/// itself.
LLVM_CORE_ABI GlobalVariable *
