...
public:
  ...
  /// elements.
  LLVM_CORE_ABI bool isFiniteNonZeroFP() const;
  ...
  LLVM_CORE_ABI bool isNormalFP() const;
  ...
  LLVM_CORE_ABI bool isElementWiseEqual(Value *Y) const;
  ...
  LLVM_CORE_ABI bool needsRelocation() const;
  LLVM_CORE_ABI bool needsDynamicRelocation() const;
  ...
  LLVM_CORE_ABI Constant *getAggregateElement(unsigned Elt) const;
  LLVM_CORE_ABI Constant *getAggregateElement(Constant *Elt) const;

  /// If all elements of the vector constant have the same value, return that
  /// value. Otherwise, return nullptr. Ignore poison elements by setting
  /// AllowPoison to true.
  LLVM_CORE_ABI Constant *getSplatValue(bool AllowPoison = false) const;

  /// If C is a constant integer then return its value, otherwise C must be a
  /// vector of constant integers, all equal, and the common value is returned.
  LLVM_CORE_ABI const APInt &getUniqueInteger() const;
  ...
  LLVM_CORE_ABI ConstantRange toConstantRange() const;
  ...
  /// method as needed.
  ///
  LLVM_CORE_ABI void handleOperandChange(Value *, Value *);

  LLVM_CORE_ABI static Constant *getNullValue(Type *Ty);

  /// @returns the value for an integer or vector of integer constant of the
  /// given type that has all its bits set to true.
  /// Get the all ones value
  LLVM_CORE_ABI static Constant *getAllOnesValue(Type *Ty);

  /// Return the value for an integer or pointer constant, or a vector thereof,
  /// with the given scalar value.
  LLVM_CORE_ABI static Constant *getIntegerValue(Type *Ty, const APInt &V);
  ...
  LLVM_CORE_ABI void removeDeadConstantUsers() const;
  ...
  LLVM_CORE_ABI bool hasOneLiveUse() const;

  /// Return true if the constant has no live uses.
  ///
  /// This returns the same result as calling Value::use_empty after
  /// Constant::removeDeadConstantUsers, but doesn't remove dead constants.
  LLVM_CORE_ABI bool hasZeroLiveUses() const;
  ...
  LLVM_CORE_ABI static Constant *replaceUndefsWith(Constant *C,
  ...
  LLVM_CORE_ABI static Constant *mergeUndefsWith(Constant *C, Constant *Other);

  /// Return true if a constant is ConstantData or a ConstantAggregate or
  /// ConstantExpr that contain only ConstantData.
  LLVM_CORE_ABI bool isManifestConstant() const;
...
private:
  ...
  LLVM_CORE_ABI PossibleRelocationsTy getRelocationInfo() const;

  LLVM_CORE_ABI bool hasNLiveUses(unsigned N) const;
};
