...
public:
  ...
  LLVM_CORE_ABI static bool canUseAsFnAttr(AttrKind Kind);
  LLVM_CORE_ABI static bool canUseAsParamAttr(AttrKind Kind);
  LLVM_CORE_ABI static bool canUseAsRetAttr(AttrKind Kind);

  LLVM_CORE_ABI static bool intersectMustPreserve(AttrKind Kind);
  LLVM_CORE_ABI static bool intersectWithAnd(AttrKind Kind);
  LLVM_CORE_ABI static bool intersectWithMin(AttrKind Kind);
  LLVM_CORE_ABI static bool intersectWithCustom(AttrKind Kind);
...
public:
  ...
  LLVM_CORE_ABI static Attribute get(LLVMContext &Context, AttrKind Kind,
                                     uint64_t Val = 0);
  LLVM_CORE_ABI static Attribute get(LLVMContext &Context, StringRef Kind,
  ...
  /// alignment set.
  LLVM_CORE_ABI static Attribute getWithAlignment(LLVMContext &Context,
                                                  Align Alignment);
  LLVM_CORE_ABI static Attribute getWithStackAlignment(LLVMContext &Context,
                                                       Align Alignment);
  LLVM_CORE_ABI static Attribute
  getWithDereferenceableBytes(LLVMContext &Context, uint64_t Bytes);
  LLVM_CORE_ABI static Attribute
  ...
  LLVM_CORE_ABI static Attribute getWithVScaleRangeArgs(LLVMContext &Context,
                                                        unsigned MinValue,
                                                        unsigned MaxValue);
  LLVM_CORE_ABI static Attribute getWithByValType(LLVMContext &Context,
                                                  Type *Ty);
  LLVM_CORE_ABI static Attribute getWithStructRetType(LLVMContext &Context,
                                                      Type *Ty);
  LLVM_CORE_ABI static Attribute getWithByRefType(LLVMContext &Context,
                                                  Type *Ty);
  LLVM_CORE_ABI static Attribute getWithPreallocatedType(LLVMContext &Context,
                                                         Type *Ty);
  LLVM_CORE_ABI static Attribute getWithInAllocaType(LLVMContext &Context,
                                                     Type *Ty);
  LLVM_CORE_ABI static Attribute getWithUWTableKind(LLVMContext &Context,
                                                    UWTableKind Kind);
  LLVM_CORE_ABI static Attribute getWithMemoryEffects(LLVMContext &Context,
                                                      MemoryEffects ME);
  LLVM_CORE_ABI static Attribute getWithNoFPClass(LLVMContext &Context,
                                                  FPClassTest Mask);
  ...
  LLVM_CORE_ABI static Attribute::AttrKind
  getAttrKindFromName(StringRef AttrName);

  LLVM_CORE_ABI static StringRef
  getNameFromAttrKind(Attribute::AttrKind AttrKind);

  /// Return true if the provided string matches the IR name of an attribute.
  /// example: "noalias" return true but not "NoAlias"
  LLVM_CORE_ABI static bool isExistingAttribute(StringRef Name);
  ...
  LLVM_CORE_ABI bool isEnumAttribute() const;

  /// Return true if the attribute is an integer attribute.
  LLVM_CORE_ABI bool isIntAttribute() const;

  /// Return true if the attribute is a string (target-dependent)
  /// attribute.
  LLVM_CORE_ABI bool isStringAttribute() const;

  /// Return true if the attribute is a type attribute.
  LLVM_CORE_ABI bool isTypeAttribute() const;

  /// Return true if the attribute is a ConstantRange attribute.
  LLVM_CORE_ABI bool isConstantRangeAttribute() const;

  /// Return true if the attribute is a ConstantRangeList attribute.
  LLVM_CORE_ABI bool isConstantRangeListAttribute() const;

  /// Return true if the attribute is any kind of attribute.
  LLVM_CORE_ABI bool isValid() const { return pImpl; }

  /// Return true if the attribute is present.
  LLVM_CORE_ABI bool hasAttribute(AttrKind Val) const;

  /// Return true if the target-dependent attribute is present.
  LLVM_CORE_ABI bool hasAttribute(StringRef Val) const;
  ...
  LLVM_CORE_ABI Attribute::AttrKind getKindAsEnum() const;

  /// Return the attribute's value as an integer. This requires that the
  /// attribute be an integer attribute.
  LLVM_CORE_ABI uint64_t getValueAsInt() const;

  /// Return the attribute's value as a boolean. This requires that the
  /// attribute be a string attribute.
  LLVM_CORE_ABI bool getValueAsBool() const;

  /// Return the attribute's kind as a string. This requires the
  /// attribute to be a string attribute.
  LLVM_CORE_ABI StringRef getKindAsString() const;

  /// Return the attribute's value as a string. This requires the
  /// attribute to be a string attribute.
  LLVM_CORE_ABI StringRef getValueAsString() const;

  /// Return the attribute's value as a Type. This requires the attribute to be
  /// a type attribute.
  LLVM_CORE_ABI Type *getValueAsType() const;

  /// Return the attribute's value as a ConstantRange. This requires the
  /// attribute to be a ConstantRange attribute.
  LLVM_CORE_ABI const ConstantRange &getValueAsConstantRange() const;

  /// Return the attribute's value as a ConstantRange array. This requires the
  /// attribute to be a ConstantRangeList attribute.
  LLVM_CORE_ABI ArrayRef<ConstantRange> getValueAsConstantRangeList() const;

  /// Returns the alignment field of an attribute as a byte alignment
  /// value.
  LLVM_CORE_ABI MaybeAlign getAlignment() const;

  /// Returns the stack alignment field of an attribute as a byte
  /// alignment value.
  LLVM_CORE_ABI MaybeAlign getStackAlignment() const;

  /// Returns the number of dereferenceable bytes from the
  /// dereferenceable attribute.
  LLVM_CORE_ABI uint64_t getDereferenceableBytes() const;

  /// Returns the number of dereferenceable_or_null bytes from the
  /// dereferenceable_or_null attribute.
  LLVM_CORE_ABI uint64_t getDereferenceableOrNullBytes() const;

  /// Returns the argument numbers for the allocsize attribute.
  LLVM_CORE_ABI std::pair<unsigned, std::optional<unsigned>>
  getAllocSizeArgs() const;

  /// Returns the minimum value for the vscale_range attribute.
  LLVM_CORE_ABI unsigned getVScaleRangeMin() const;

  /// Returns the maximum value for the vscale_range attribute or std::nullopt
  /// when unknown.
  LLVM_CORE_ABI std::optional<unsigned> getVScaleRangeMax() const;

  // Returns the unwind table kind.
  LLVM_CORE_ABI UWTableKind getUWTableKind() const;

  // Returns the allocator function kind.
  LLVM_CORE_ABI AllocFnKind getAllocKind() const;

  /// Returns memory effects.
  LLVM_CORE_ABI MemoryEffects getMemoryEffects() const;

  /// Returns information from captures attribute.
  LLVM_CORE_ABI CaptureInfo getCaptureInfo() const;

  /// Return the FPClassTest for nofpclass
  LLVM_CORE_ABI FPClassTest getNoFPClass() const;

  /// Returns the value of the range attribute.
  LLVM_CORE_ABI const ConstantRange &getRange() const;

  /// Returns the value of the initializes attribute.
  LLVM_CORE_ABI ArrayRef<ConstantRange> getInitializes() const;

  /// The Attribute is converted to a string of equivalent mnemonic. This
  /// is, presumably, for writing out the mnemonics for the assembly writer.
  LLVM_CORE_ABI std::string getAsString(bool InAttrGrp = false) const;

  /// Return true if this attribute belongs to the LLVMContext.
  LLVM_CORE_ABI bool hasParentContext(LLVMContext &C) const;
  ...
  LLVM_CORE_ABI int cmpKind(Attribute A) const;

  /// Less-than operator. Useful for sorting the attributes list.
  LLVM_CORE_ABI bool operator<(Attribute A) const;

  LLVM_CORE_ABI void Profile(FoldingSetNodeID &ID) const;
...
public:
  ...
  LLVM_CORE_ABI static AttributeSet get(LLVMContext &C, const AttrBuilder &B);
  LLVM_CORE_ABI static AttributeSet get(LLVMContext &C,
  ...
  /// immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeSet
  addAttribute(LLVMContext &C, Attribute::AttrKind Kind) const;

  /// Add a target-dependent attribute. Returns a new set because attribute sets
  /// are immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeSet addAttribute(
      LLVMContext &C, StringRef Kind, StringRef Value = StringRef()) const;

  /// Add attributes to the attribute set. Returns a new set because attribute
  /// sets are immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeSet addAttributes(LLVMContext &C,
  ...
  /// just analysis).
  [[nodiscard]] LLVM_CORE_ABI std::optional<AttributeSet>
  intersectWith(LLVMContext &C, AttributeSet Other) const;

  /// Return the number of attributes in this set.
  LLVM_CORE_ABI unsigned getNumAttributes() const;

  /// Return true if attributes exists in this set.
  bool hasAttributes() const { return SetNode != nullptr; }

  /// Return true if the attribute exists in this set.
  LLVM_CORE_ABI bool hasAttribute(Attribute::AttrKind Kind) const;

  /// Return true if the attribute exists in this set.
  LLVM_CORE_ABI bool hasAttribute(StringRef Kind) const;

  /// Return the attribute object.
  LLVM_CORE_ABI Attribute getAttribute(Attribute::AttrKind Kind) const;

  /// Return the target-dependent attribute object.
  LLVM_CORE_ABI Attribute getAttribute(StringRef Kind) const;

  LLVM_CORE_ABI MaybeAlign getAlignment() const;
  LLVM_CORE_ABI MaybeAlign getStackAlignment() const;
  LLVM_CORE_ABI uint64_t getDereferenceableBytes() const;
  LLVM_CORE_ABI uint64_t getDereferenceableOrNullBytes() const;
  LLVM_CORE_ABI Type *getByValType() const;
  LLVM_CORE_ABI Type *getStructRetType() const;
  LLVM_CORE_ABI Type *getByRefType() const;
  LLVM_CORE_ABI Type *getPreallocatedType() const;
  LLVM_CORE_ABI Type *getInAllocaType() const;
  LLVM_CORE_ABI Type *getElementType() const;
  LLVM_CORE_ABI std::optional<std::pair<unsigned, std::optional<unsigned>>>
  getAllocSizeArgs() const;
  LLVM_CORE_ABI unsigned getVScaleRangeMin() const;
  LLVM_CORE_ABI std::optional<unsigned> getVScaleRangeMax() const;
  LLVM_CORE_ABI UWTableKind getUWTableKind() const;
  ...
  LLVM_CORE_ABI iterator begin() const;
  LLVM_CORE_ABI iterator end() const;
...
public:
  ...
  LLVM_CORE_ABI static AttributeList
  ...
  LLVM_CORE_ABI static AttributeList get(LLVMContext &C, AttributeSet FnAttrs,
...
public:
  ...
  LLVM_CORE_ABI static AttributeList get(LLVMContext &C,
                                         ArrayRef<AttributeList> Attrs);
  LLVM_CORE_ABI static AttributeList get(LLVMContext &C, unsigned Index,
  ...
  [[nodiscard]] LLVM_CORE_ABI AttributeList
  ...
  /// Returns a new list because attribute lists are immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeList addAttributesAtIndex(
  ...
  [[nodiscard]] LLVM_CORE_ABI AttributeList addParamAttribute(
  ...
  [[nodiscard]] LLVM_CORE_ABI AttributeList removeAttributeAtIndex(
  ...
  /// attribute list. Returns a new list because attribute lists are immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeList removeAttributesAtIndex(
  ...
  [[nodiscard]] LLVM_CORE_ABI AttributeList addDereferenceableParamAttr(
      LLVMContext &C, unsigned ArgNo, uint64_t Bytes) const;

  /// Add the dereferenceable_or_null attribute to the attribute set at
  /// the given arg index. Returns a new list because attribute lists are
  /// immutable.
  [[nodiscard]] LLVM_CORE_ABI AttributeList addDereferenceableOrNullParamAttr(
      LLVMContext &C, unsigned ArgNo, uint64_t Bytes) const;
  ...
  /// the two lists are inherently incompatible (imply different behavior, not
  /// just analysis).
  [[nodiscard]] LLVM_CORE_ABI std::optional<AttributeList>
  ...
  LLVM_CORE_ABI AttributeSet getAttributes(unsigned Index) const;

  /// The attributes for the argument or parameter at the given index are
  /// returned.
  LLVM_CORE_ABI AttributeSet getParamAttrs(unsigned ArgNo) const;

  /// The attributes for the ret value are returned.
  LLVM_CORE_ABI AttributeSet getRetAttrs() const;

  /// The function attributes are returned.
  LLVM_CORE_ABI AttributeSet getFnAttrs() const;

  /// Return true if the attribute exists at the given index.
  LLVM_CORE_ABI bool hasAttributeAtIndex(unsigned Index,
                                         Attribute::AttrKind Kind) const;

  /// Return true if the attribute exists at the given index.
  LLVM_CORE_ABI bool hasAttributeAtIndex(unsigned Index, StringRef Kind) const;

  /// Return true if attribute exists at the given index.
  LLVM_CORE_ABI bool hasAttributesAtIndex(unsigned Index) const;
  ...
  LLVM_CORE_ABI bool hasFnAttr(Attribute::AttrKind Kind) const;

  /// Return true if the attribute exists for the function.
  LLVM_CORE_ABI bool hasFnAttr(StringRef Kind) const;
  ...
  LLVM_CORE_ABI bool hasAttrSomewhere(Attribute::AttrKind Kind,
                                      unsigned *Index = nullptr) const;

  /// Return the attribute object that exists at the given index.
  LLVM_CORE_ABI Attribute getAttributeAtIndex(unsigned Index,
                                              Attribute::AttrKind Kind) const;
  ...
  LLVM_CORE_ABI MaybeAlign getRetAlignment() const;

  /// Return the alignment for the specified function parameter.
  LLVM_CORE_ABI MaybeAlign getParamAlignment(unsigned ArgNo) const;

  /// Return the stack alignment for the specified function parameter.
  LLVM_CORE_ABI MaybeAlign getParamStackAlignment(unsigned ArgNo) const;

  /// Return the byval type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamByValType(unsigned ArgNo) const;

  /// Return the sret type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamStructRetType(unsigned ArgNo) const;

  /// Return the byref type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamByRefType(unsigned ArgNo) const;

  /// Return the preallocated type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamPreallocatedType(unsigned ArgNo) const;

  /// Return the inalloca type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamInAllocaType(unsigned ArgNo) const;

  /// Return the elementtype type for the specified function parameter.
  LLVM_CORE_ABI Type *getParamElementType(unsigned ArgNo) const;

  /// Get the stack alignment of the function.
  LLVM_CORE_ABI MaybeAlign getFnStackAlignment() const;

  /// Get the stack alignment of the return value.
  LLVM_CORE_ABI MaybeAlign getRetStackAlignment() const;

  /// Get the number of dereferenceable bytes (or zero if unknown) of the return
  /// value.
  LLVM_CORE_ABI uint64_t getRetDereferenceableBytes() const;

  /// Get the number of dereferenceable bytes (or zero if unknown) of an arg.
  LLVM_CORE_ABI uint64_t getParamDereferenceableBytes(unsigned Index) const;

  /// Get the number of dereferenceable_or_null bytes (or zero if unknown) of
  /// the return value.
  LLVM_CORE_ABI uint64_t getRetDereferenceableOrNullBytes() const;

  /// Get the number of dereferenceable_or_null bytes (or zero if unknown) of an
  /// arg.
  LLVM_CORE_ABI uint64_t
  getParamDereferenceableOrNullBytes(unsigned ArgNo) const;

  /// Get range (or std::nullopt if unknown) of an arg.
  LLVM_CORE_ABI std::optional<ConstantRange>
  getParamRange(unsigned ArgNo) const;

  /// Get the disallowed floating-point classes of the return value.
  LLVM_CORE_ABI FPClassTest getRetNoFPClass() const;

  /// Get the disallowed floating-point classes of the argument value.
  LLVM_CORE_ABI FPClassTest getParamNoFPClass(unsigned ArgNo) const;
  ...
  LLVM_CORE_ABI std::string getAsString(unsigned Index,
  ...
  LLVM_CORE_ABI unsigned getNumAttrSets() const;
...
public:
  ...
  LLVM_CORE_ABI AttrBuilder(LLVMContext &Ctx, AttributeSet AS);

  LLVM_CORE_ABI void clear();

  /// Add an attribute to the builder.
  LLVM_CORE_ABI AttrBuilder &addAttribute(Attribute::AttrKind Val);

  /// Add the Attribute object to the builder.
  LLVM_CORE_ABI AttrBuilder &addAttribute(Attribute A);

  /// Add the target-dependent attribute to the builder.
  LLVM_CORE_ABI AttrBuilder &addAttribute(StringRef A,
                                          StringRef V = StringRef());

  /// Remove an attribute from the builder.
  LLVM_CORE_ABI AttrBuilder &removeAttribute(Attribute::AttrKind Val);

  /// Remove the target-dependent attribute from the builder.
  LLVM_CORE_ABI AttrBuilder &removeAttribute(StringRef A);

  /// Remove the target-dependent attribute from the builder.
  LLVM_CORE_ABI AttrBuilder &removeAttribute(Attribute A) {
  ...
  LLVM_CORE_ABI AttrBuilder &merge(const AttrBuilder &B);

  /// Remove the attributes from the builder.
  LLVM_CORE_ABI AttrBuilder &remove(const AttributeMask &AM);

  /// Return true if the builder has any attribute that's in the
  /// specified builder.
  LLVM_CORE_ABI bool overlaps(const AttributeMask &AM) const;

  /// Return true if the builder has the specified attribute.
  LLVM_CORE_ABI bool contains(Attribute::AttrKind A) const;

  /// Return true if the builder has the specified target-dependent
  /// attribute.
  LLVM_CORE_ABI bool contains(StringRef A) const;
  ...
  LLVM_CORE_ABI std::optional<uint64_t>
  ...
  LLVM_CORE_ABI Type *getTypeAttr(Attribute::AttrKind Kind) const;
  ...
  LLVM_CORE_ABI AttrBuilder &addRawIntAttr(Attribute::AttrKind Kind,
                                           uint64_t Value);

  /// This turns an alignment into the form used internally in Attribute.
  /// This call has no effect if Align is not set.
  LLVM_CORE_ABI AttrBuilder &addAlignmentAttr(MaybeAlign Align);
  ...
  /// This call has no effect if Align is not set.
  LLVM_CORE_ABI AttrBuilder &addStackAlignmentAttr(MaybeAlign Align);
  ...
  LLVM_CORE_ABI AttrBuilder &addDereferenceableAttr(uint64_t Bytes);

  /// This turns the number of dereferenceable_or_null bytes into the
  /// form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addDereferenceableOrNullAttr(uint64_t Bytes);

  /// This turns one (or two) ints into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &
  addAllocSizeAttr(unsigned ElemSizeArg,
                                const std::optional<unsigned> &NumElemsArg);

  /// This turns two ints into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &
  addVScaleRangeAttr(unsigned MinValue,
                                  std::optional<unsigned> MaxValue);

  /// Add a type attribute with the given type.
  LLVM_CORE_ABI AttrBuilder &addTypeAttr(Attribute::AttrKind Kind, Type *Ty);

  /// This turns a byval type into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addByValAttr(Type *Ty);

  /// This turns a sret type into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addStructRetAttr(Type *Ty);

  /// This turns a byref type into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addByRefAttr(Type *Ty);

  /// This turns a preallocated type into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addPreallocatedAttr(Type *Ty);

  /// This turns an inalloca type into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addInAllocaAttr(Type *Ty);
  ...
  /// Attribute.
  LLVM_CORE_ABI AttrBuilder &addUWTableAttr(UWTableKind Kind);

  // This turns the allocator kind into the form used internally in Attribute.
  LLVM_CORE_ABI AttrBuilder &addAllocKindAttr(AllocFnKind Kind);

  /// Add memory effect attribute.
  LLVM_CORE_ABI AttrBuilder &addMemoryAttr(MemoryEffects ME);

  /// Add captures attribute.
  LLVM_CORE_ABI AttrBuilder &addCapturesAttr(CaptureInfo CI);

  // Add nofpclass attribute
  LLVM_CORE_ABI AttrBuilder &addNoFPClassAttr(FPClassTest NoFPClassMask);

  /// Add a ConstantRange attribute with the given range.
  LLVM_CORE_ABI AttrBuilder &addConstantRangeAttr(Attribute::AttrKind Kind,
                                    const ConstantRange &CR);

  /// Add range attribute.
  LLVM_CORE_ABI AttrBuilder &addRangeAttr(const ConstantRange &CR);

  /// Add a ConstantRangeList attribute with the given ranges.
  LLVM_CORE_ABI AttrBuilder &
  addConstantRangeListAttr(Attribute::AttrKind Kind,
                                        ArrayRef<ConstantRange> Val);

  /// Add initializes attribute.
  LLVM_CORE_ABI AttrBuilder &addInitializesAttr(const ConstantRangeList &CRL);

  ArrayRef<Attribute> attrs() const { return Attrs; }

  LLVM_CORE_ABI bool operator==(const AttrBuilder &B) const;
...
LLVM_CORE_ABI bool isNoFPClassCompatibleType(Type *Ty);
...
LLVM_CORE_ABI AttributeMask typeIncompatible(Type *Ty, AttributeSet AS,
...
LLVM_CORE_ABI AttributeMask getUBImplyingAttributes();

/// \returns Return true if the two functions have compatible target-independent
/// attributes for inlining purposes.
LLVM_CORE_ABI bool areInlineCompatible(const Function &Caller,
...
LLVM_CORE_ABI bool areOutlineCompatible(const Function &A, const Function &B);

/// Merge caller's and callee's attributes.
LLVM_CORE_ABI void mergeAttributesForInlining(Function &Caller,
                                              const Function &Callee);
...
LLVM_CORE_ABI void mergeAttributesForOutlining(Function &Base,
                                               const Function &ToMerge);

/// Update min-legal-vector-width if it is in Attribute and less than Width.
LLVM_CORE_ABI void updateMinLegalVectorWidthAttr(Function &Fn, uint64_t Width);
