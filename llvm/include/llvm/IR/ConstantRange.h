...
public:
  ...
  LLVM_CORE_ABI explicit ConstantRange(uint32_t BitWidth, bool isFullSet);

  /// Initialize a range to hold the single specified value.
  LLVM_CORE_ABI ConstantRange(APInt Value);

  /// Initialize a range of values explicitly. This will assert out if
  /// Lower==Upper and Lower != Min or Max value for its type. It will also
  /// assert out if the two APInt's are not the same bit width.
  LLVM_CORE_ABI ConstantRange(APInt Lower, APInt Upper);
  ...
  /// unsigned domain.
  LLVM_CORE_ABI static ConstantRange fromKnownBits(const KnownBits &Known,
                                                   bool IsSigned);
  ...
  LLVM_CORE_ABI static ConstantRange
  ...
  LLVM_CORE_ABI static ConstantRange
  makeExactICmpRegion(CmpInst::Predicate Pred, const APInt &Other);

  /// Does the predicate \p Pred hold between ranges this and \p Other?
  /// NOTE: false does not mean that inverse predicate holds!
  LLVM_CORE_ABI bool icmp(CmpInst::Predicate Pred,
  ...
  LLVM_CORE_ABI static CmpInst::Predicate
  ...
  LLVM_CORE_ABI static ConstantRange makeMaskNotEqualRange(const APInt &Mask,
                                                           const APInt &C);

  /// Returns true if ConstantRange calculations are supported for intrinsic
  /// with \p IntrinsicID.
  LLVM_CORE_ABI static bool isIntrinsicSupported(Intrinsic::ID IntrinsicID);

  /// Compute range of intrinsic result for the given operand ranges.
  LLVM_CORE_ABI static ConstantRange intrinsic(Intrinsic::ID IntrinsicID,
                                               ArrayRef<ConstantRange> Ops);

  /// Set up \p Pred and \p RHS such that
  /// ConstantRange::makeExactICmpRegion(Pred, RHS) == *this.  Return true if
  /// successful.
  LLVM_CORE_ABI bool getEquivalentICmp(CmpInst::Predicate &Pred,
                                       APInt &RHS) const;
  ...
  /// for this data-type.
  LLVM_CORE_ABI bool isFullSet() const;

  /// Return true if this set contains no members.
  LLVM_CORE_ABI bool isEmptySet() const;
  ...
  LLVM_CORE_ABI bool isWrappedSet() const;
  ...
  ///  * Full set: Not wrapped.
  ///  * [X, SignedMin): Wrapped.
  LLVM_CORE_ABI bool isUpperSignWrapped() const;

  /// Return true if the specified value is in the set.
  LLVM_CORE_ABI bool contains(const APInt &Val) const;

  /// Return true if the other range is a subset of this one.
  LLVM_CORE_ABI bool contains(const ConstantRange &CR) const;
  ...
  LLVM_CORE_ABI bool isSizeStrictlySmallerThan(const ConstantRange &CR) const;

  /// Compare set size of this range with Value.
  LLVM_CORE_ABI bool isSizeLargerThan(uint64_t MaxSize) const;

  /// Return true if all values in this range are negative.
  LLVM_CORE_ABI bool isAllNegative() const;

  /// Return true if all values in this range are non-negative.
  LLVM_CORE_ABI bool isAllNonNegative() const;

  /// Return true if all values in this range are positive.
  LLVM_CORE_ABI bool isAllPositive() const;

  /// Return the largest unsigned value contained in the ConstantRange.
  LLVM_CORE_ABI APInt getUnsignedMax() const;

  /// Return the smallest unsigned value contained in the ConstantRange.
  LLVM_CORE_ABI APInt getUnsignedMin() const;

  /// Return the largest signed value contained in the ConstantRange.
  LLVM_CORE_ABI APInt getSignedMax() const;

  /// Return the smallest signed value contained in the ConstantRange.
  LLVM_CORE_ABI APInt getSignedMin() const;
  ...
  /// in this range.
  LLVM_CORE_ABI unsigned getActiveBits() const;

  /// Compute the maximal number of bits needed to represent every value
  /// in this signed range.
  LLVM_CORE_ABI unsigned getMinSignedBits() const;

  /// Subtract the specified constant from the endpoints of this constant range.
  LLVM_CORE_ABI ConstantRange subtract(const APInt &CI) const;

  /// Subtract the specified range from this range (aka relative complement of
  /// the sets).
  LLVM_CORE_ABI ConstantRange difference(const ConstantRange &CR) const;
  ...
  LLVM_CORE_ABI ConstantRange intersectWith(
  ...
  LLVM_CORE_ABI ConstantRange
  unionWith(const ConstantRange &CR, PreferredRangeType Type = Smallest) const;
  ...
  LLVM_CORE_ABI ConstantRange castOp(Instruction::CastOps CastOp,
  ...
  LLVM_CORE_ABI ConstantRange zeroExtend(uint32_t BitWidth) const;

  /// Return a new range in the specified integer type, which must
  /// be strictly larger than the current type.  The returned range will
  /// correspond to the possible range of values if the source range had been
  /// sign extended to BitWidth.
  LLVM_CORE_ABI ConstantRange signExtend(uint32_t BitWidth) const;

  /// Return a new range in the specified integer type, which must be
  /// strictly smaller than the current type.  The returned range will
  /// correspond to the possible range of values if the source range had been
  /// truncated to the specified type.
  LLVM_CORE_ABI ConstantRange truncate(uint32_t BitWidth) const;

  /// Make this range have the bit width given by \p BitWidth. The
  /// value is zero extended, truncated, or left alone to make it that width.
  LLVM_CORE_ABI ConstantRange zextOrTrunc(uint32_t BitWidth) const;

  /// Make this range have the bit width given by \p BitWidth. The
  /// value is sign extended, truncated, or left alone to make it that width.
  LLVM_CORE_ABI ConstantRange sextOrTrunc(uint32_t BitWidth) const;

  /// Return a new range representing the possible values resulting
  /// from an application of the specified binary operator to an left hand side
  /// of this range and a right hand side of \p Other.
  LLVM_CORE_ABI ConstantRange binaryOp(Instruction::BinaryOps BinOp,
                                       const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange overflowingBinaryOp(Instruction::BinaryOps BinOp,
                                                  const ConstantRange &Other,
                                                  unsigned NoWrapKind) const;

  /// Return a new range representing the possible values resulting
  /// from an addition of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange add(const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange sub(const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange multiply(const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange smul_fast(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a signed maximum of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange smax(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from an unsigned maximum of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange umax(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a signed minimum of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange smin(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from an unsigned minimum of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange umin(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from an unsigned division of a value in this range and a value in
  /// \p Other.
  LLVM_CORE_ABI ConstantRange udiv(const ConstantRange &Other) const;
  ...
  /// result.
  LLVM_CORE_ABI ConstantRange sdiv(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from an unsigned remainder operation of a value in this range and a
  /// value in \p Other.
  LLVM_CORE_ABI ConstantRange urem(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a signed remainder operation of a value in this range and a
  /// value in \p Other.
  LLVM_CORE_ABI ConstantRange srem(const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange binaryNot() const;

  /// Return a new range representing the possible values resulting
  /// from a binary-and of a value in this range by a value in \p Other.
  LLVM_CORE_ABI ConstantRange binaryAnd(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a binary-or of a value in this range by a value in \p Other.
  LLVM_CORE_ABI ConstantRange binaryOr(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a binary-xor of a value in this range by a value in \p Other.
  LLVM_CORE_ABI ConstantRange binaryXor(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting
  /// from a left shift of a value in this range by a value in \p Other.
  /// TODO: This isn't fully implemented yet.
  LLVM_CORE_ABI ConstantRange shl(const ConstantRange &Other) const;
  ...
  LLVM_CORE_ABI ConstantRange lshr(const ConstantRange &Other) const;

  /// Return a new range representing the possible values resulting from a
  /// arithmetic right shift of a value in this range and a value in \p Other.
  LLVM_CORE_ABI ConstantRange ashr(const ConstantRange &Other) const;

  /// Perform an unsigned saturating addition of two constant ranges.
  LLVM_CORE_ABI ConstantRange uadd_sat(const ConstantRange &Other) const;

  /// Perform a signed saturating addition of two constant ranges.
  LLVM_CORE_ABI ConstantRange sadd_sat(const ConstantRange &Other) const;

  /// Perform an unsigned saturating subtraction of two constant ranges.
  LLVM_CORE_ABI ConstantRange usub_sat(const ConstantRange &Other) const;

  /// Perform a signed saturating subtraction of two constant ranges.
  LLVM_CORE_ABI ConstantRange ssub_sat(const ConstantRange &Other) const;

  /// Perform an unsigned saturating multiplication of two constant ranges.
  LLVM_CORE_ABI ConstantRange umul_sat(const ConstantRange &Other) const;

  /// Perform a signed saturating multiplication of two constant ranges.
  LLVM_CORE_ABI ConstantRange smul_sat(const ConstantRange &Other) const;

  /// Perform an unsigned saturating left shift of this constant range by a
  /// value in \p Other.
  LLVM_CORE_ABI ConstantRange ushl_sat(const ConstantRange &Other) const;

  /// Perform a signed saturating left shift of this constant range by a
  /// value in \p Other.
  LLVM_CORE_ABI ConstantRange sshl_sat(const ConstantRange &Other) const;

  /// Return a new range that is the logical not of the current set.
  LLVM_CORE_ABI ConstantRange inverse() const;
  ...
  LLVM_CORE_ABI ConstantRange abs(bool IntMinIsPoison = false) const;
  ...
  LLVM_CORE_ABI ConstantRange ctlz(bool ZeroIsPoison = false) const;

  /// Calculate cttz range. If \p ZeroIsPoison is set, the range is computed
  /// ignoring a possible zero value contained in the input range.
  LLVM_CORE_ABI ConstantRange cttz(bool ZeroIsPoison = false) const;

  /// Calculate ctpop range.
  LLVM_CORE_ABI ConstantRange ctpop() const;
  ...
  LLVM_CORE_ABI KnownBits toKnownBits() const;
...
LLVM_CORE_ABI ConstantRange getConstantRangeFromMetadata(const MDNode &RangeMD);
