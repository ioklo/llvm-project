...
namespace llvm {
  ...
  LLVM_CORE_ABI Constant *
  ConstantFoldSelectInstruction(Constant *Cond, Constant *V1, Constant *V2);
  LLVM_CORE_ABI Constant *ConstantFoldExtractElementInstruction(Constant *Val,
                                                                Constant *Idx);
  LLVM_CORE_ABI Constant *ConstantFoldInsertElementInstruction(Constant *Val,
                                                               Constant *Elt,
                                                               Constant *Idx);
  LLVM_CORE_ABI Constant *
  ConstantFoldShuffleVectorInstruction(Constant *V1, Constant *V2,
                                       ArrayRef<int> Mask);
  LLVM_CORE_ABI Constant *
  ...
  LLVM_CORE_ABI Constant *ConstantFoldUnaryInstruction(unsigned Opcode,
                                                       Constant *V);
  LLVM_CORE_ABI Constant *
