...
LLVM_CORE_ABI stable_hash StructuralHash(const Function &F,
                                         bool DetailedHash = false);

/// Returns a hash of the global variable \p G.
LLVM_CORE_ABI stable_hash StructuralHash(const GlobalVariable &G);
...
LLVM_CORE_ABI stable_hash StructuralHash(const Module &M,
                                         bool DetailedHash = false);
...
LLVM_CORE_ABI FunctionHashInfo
