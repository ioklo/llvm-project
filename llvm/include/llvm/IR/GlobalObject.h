...
public:
  ...
  LLVM_CORE_ABI void setAlignment(Align Align);

  /// Sets the alignment attribute of the GlobalObject.
  /// This method will be deprecated as the alignment property should always be
  /// defined.
  LLVM_CORE_ABI void setAlignment(MaybeAlign Align);
  ...
  LLVM_CORE_ABI void setSection(StringRef S);

  bool hasComdat() const { return getComdat() != nullptr; }
  const Comdat *getComdat() const { return ObjComdat; }
  Comdat *getComdat() { return ObjComdat; }
  LLVM_CORE_ABI void setComdat(Comdat *C);
  ...
  LLVM_CORE_ABI void copyMetadata(const GlobalObject *Src, unsigned Offset);

  LLVM_CORE_ABI void addTypeMetadata(unsigned Offset, Metadata *TypeID);
  LLVM_CORE_ABI void setVCallVisibilityMetadata(VCallVisibility Visibility);
  LLVM_CORE_ABI VCallVisibility getVCallVisibility() const;
  ...
  /// Note that for functions this is the alignment of the code, not the
  /// alignment of a function pointer.
  LLVM_CORE_ABI bool canIncreaseAlignment() const;

protected:
  LLVM_CORE_ABI void copyAttributesFrom(const GlobalObject *Src);
...
private:
  ...
  LLVM_CORE_ABI StringRef getSectionImpl() const;
};
