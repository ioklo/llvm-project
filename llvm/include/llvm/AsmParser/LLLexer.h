...
public:
  LLVM_ASMPARSER_ABI explicit LLLexer(StringRef StartBuf, SourceMgr &SM,
  ...
  LLVM_ASMPARSER_ABI void Warning(LocTy WarningLoc, const Twine &Msg) const;
  void Warning(const Twine &Msg) const { return Warning(getLoc(), Msg); }

private:
  LLVM_ASMPARSER_ABI lltok::Kind LexToken();
