...
LLVM_SUPPORT_ABI StringRef::size_type StrInStrNoCase(StringRef s1,
                                                     StringRef s2);
...
LLVM_SUPPORT_ABI std::pair<StringRef, StringRef>
getToken(StringRef Source, StringRef Delimiters = " \t\n\v\f\r");

/// SplitString - Split up the specified string according to the specified
/// delimiters, appending the result fragments to the output list.
LLVM_SUPPORT_ABI void SplitString(StringRef Source,
...
convertToCamelFromSnakeCase(StringRef input, bool capitalizeFirst = false);
