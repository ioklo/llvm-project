...
protected:
  ...
  LLVM_SUPPORT_ABI void RegisterStatistic();
};
...
LLVM_SUPPORT_ABI std::unique_ptr<raw_ostream> CreateInfoOutputFile();
...
/// completes.
LLVM_SUPPORT_ABI std::vector<std::pair<StringRef, uint64_t>> GetStatistics();
