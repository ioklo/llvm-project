...
public:
  ...
  LLVM_SUPPORT_ABI raw_ostream &write(raw_ostream &Stream) const;

  /// RemoveText - Remove the specified text.
  LLVM_SUPPORT_ABI void RemoveText(unsigned OrigOffset, unsigned Size,
                                   bool removeLineIfEmpty = false);

  /// InsertText - Insert some text at the specified point, where the offset in
  /// the buffer is specified relative to the original SourceBuffer.  The
  /// text is inserted after the specified location.
  LLVM_SUPPORT_ABI void InsertText(unsigned OrigOffset, StringRef Str,
  ...
  /// operation.
  LLVM_SUPPORT_ABI void ReplaceText(unsigned OrigOffset, unsigned OrigLength,
                                    StringRef NewStr);
