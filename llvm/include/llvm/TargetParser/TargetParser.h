...
LLVM_TARGETPARSER_ABI StringRef getArchFamilyNameAMDGCN(GPUKind AK);

LLVM_TARGETPARSER_ABI StringRef getArchNameAMDGCN(GPUKind AK);
LLVM_TARGETPARSER_ABI StringRef getArchNameR600(GPUKind AK);
LLVM_TARGETPARSER_ABI StringRef getCanonicalArchName(const Triple &T, StringRef Arch);
LLVM_TARGETPARSER_ABI GPUKind parseArchAMDGCN(StringRef CPU);
LLVM_TARGETPARSER_ABI GPUKind parseArchR600(StringRef CPU);
LLVM_TARGETPARSER_ABI unsigned getArchAttrAMDGCN(GPUKind AK);
LLVM_TARGETPARSER_ABI unsigned getArchAttrR600(GPUKind AK);

LLVM_TARGETPARSER_ABI void fillValidArchListAMDGCN(SmallVectorImpl<StringRef> &Values);
LLVM_TARGETPARSER_ABI void fillValidArchListR600(SmallVectorImpl<StringRef> &Values);

LLVM_TARGETPARSER_ABI IsaVersion getIsaVersion(StringRef GPU);

/// Fills Features map with default values for given target GPU
LLVM_TARGETPARSER_ABI void fillAMDGPUFeatureMap(StringRef GPU, const Triple &T,
                          StringMap<bool> &Features);

/// Inserts wave size feature for given GPU into features map
LLVM_TARGETPARSER_ABI std::pair<FeatureError, StringRef>
