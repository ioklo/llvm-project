...
public:
  ...
  LLVM_TARGETPARSER_ABI explicit Triple(const Twine &Str);
  LLVM_TARGETPARSER_ABI Triple(const Twine &ArchStr, const Twine &VendorStr,
                               const Twine &OSStr);
  LLVM_TARGETPARSER_ABI Triple(const Twine &ArchStr, const Twine &VendorStr,
  ...
  LLVM_TARGETPARSER_ABI static std::string
  ...
  LLVM_TARGETPARSER_ABI VersionTuple getEnvironmentVersion() const;
  ...
  ///
  /// For example, "fooos1.2.3" would return (1, 2, 3).
  LLVM_TARGETPARSER_ABI VersionTuple getOSVersion() const;
  ...
  LLVM_TARGETPARSER_ABI bool getMacOSXVersion(VersionTuple &Version) const;

  /// Parse the version number as with getOSVersion.  This should only be called
  /// with IOS or generic triples.
  LLVM_TARGETPARSER_ABI VersionTuple getiOSVersion() const;

  /// Parse the version number as with getOSVersion.  This should only be called
  /// with WatchOS or generic triples.
  LLVM_TARGETPARSER_ABI VersionTuple getWatchOSVersion() const;

  /// Parse the version number as with getOSVersion.
  LLVM_TARGETPARSER_ABI VersionTuple getDriverKitVersion() const;
  ...
  LLVM_TARGETPARSER_ABI StringRef getArchName() const;

  /// Get the vendor (second) component of the triple.
  LLVM_TARGETPARSER_ABI StringRef getVendorName() const;

  /// Get the operating system (third) component of the triple.
  LLVM_TARGETPARSER_ABI StringRef getOSName() const;

  /// Get the optional environment (fourth) component of the triple, or "" if
  /// empty.
  LLVM_TARGETPARSER_ABI StringRef getEnvironmentName() const;

  /// Get the operating system and optional environment components as a single
  /// string (separated by a '-' if the environment component is present).
  LLVM_TARGETPARSER_ABI StringRef getOSAndEnvironmentName() const;

  /// Get the version component of the environment component as a single
  /// string (the version after the environment).
  ///
  /// For example, "fooos1.2.3" would return "1.2.3".
  LLVM_TARGETPARSER_ABI StringRef getEnvironmentVersionString() const;
  ...
  LLVM_TARGETPARSER_ABI static unsigned
  ...
  LLVM_TARGETPARSER_ABI unsigned getTrampolineSize() const;
  ...
  /// system is provided.
  LLVM_TARGETPARSER_ABI bool isArch64Bit() const;

  /// Test whether the architecture is 32-bit
  ///
  /// Note that this tests for 32-bit pointer width, and nothing else.
  LLVM_TARGETPARSER_ABI bool isArch32Bit() const;

  /// Test whether the architecture is 16-bit
  ///
  /// Note that this tests for 16-bit pointer width, and nothing else.
  LLVM_TARGETPARSER_ABI bool isArch16Bit() const;
  ...
  LLVM_TARGETPARSER_ABI bool isMacOSXVersionLT(unsigned Major,
                                               unsigned Minor = 0,
                                               unsigned Micro = 0) const;
  ...
  LLVM_TARGETPARSER_ABI void setArch(ArchType Kind,
                                     SubArchType SubArch = NoSubArch);

  /// Set the vendor (second) component of the triple to a known type.
  LLVM_TARGETPARSER_ABI void setVendor(VendorType Kind);

  /// Set the operating system (third) component of the triple to a known type.
  LLVM_TARGETPARSER_ABI void setOS(OSType Kind);

  /// Set the environment (fourth) component of the triple to a known type.
  LLVM_TARGETPARSER_ABI void setEnvironment(EnvironmentType Kind);

  /// Set the object file format.
  LLVM_TARGETPARSER_ABI void setObjectFormat(ObjectFormatType Kind);

  /// Set all components to the new triple \p Str.
  LLVM_TARGETPARSER_ABI void setTriple(const Twine &Str);

  /// Set the architecture (first) component of the triple by name.
  LLVM_TARGETPARSER_ABI void setArchName(StringRef Str);

  /// Set the vendor (second) component of the triple by name.
  LLVM_TARGETPARSER_ABI void setVendorName(StringRef Str);

  /// Set the operating system (third) component of the triple by name.
  LLVM_TARGETPARSER_ABI void setOSName(StringRef Str);

  /// Set the optional environment (fourth) component of the triple by name.
  LLVM_TARGETPARSER_ABI void setEnvironmentName(StringRef Str);

  /// Set the operating system and optional environment components with a single
  /// string.
  LLVM_TARGETPARSER_ABI void setOSAndEnvironmentName(StringRef Str);
  ...
  LLVM_TARGETPARSER_ABI llvm::Triple get32BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  LLVM_TARGETPARSER_ABI llvm::Triple get64BitArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  LLVM_TARGETPARSER_ABI llvm::Triple getBigEndianArchVariant() const;
  ...
  ///          architecture if no such variant can be found.
  LLVM_TARGETPARSER_ABI llvm::Triple getLittleEndianArchVariant() const;

  /// Tests whether the target triple is little endian.
  ///
  /// \returns true if the triple is little endian, false otherwise.
  LLVM_TARGETPARSER_ABI bool isLittleEndian() const;

  /// Test whether target triples are compatible.
  LLVM_TARGETPARSER_ABI bool isCompatibleWith(const Triple &Other) const;

  /// Merge target triples.
  LLVM_TARGETPARSER_ABI std::string merge(const Triple &Other) const;

  /// Some platforms have different minimum supported OS versions that
  /// varies by the architecture specified in the triple. This function
  /// returns the minimum supported OS version for this triple if one an exists,
  /// or an invalid version tuple if this triple doesn't have one.
  LLVM_TARGETPARSER_ABI VersionTuple getMinimumSupportedOSVersion() const;
  ...
  LLVM_TARGETPARSER_ABI static StringRef getArchTypeName(ArchType Kind);

  /// Get the architecture name based on \p Kind and \p SubArch.
  LLVM_TARGETPARSER_ABI static StringRef
  getArchName(ArchType Kind, SubArchType SubArch = NoSubArch);
  ...
  LLVM_TARGETPARSER_ABI static StringRef getArchTypePrefix(ArchType Kind);

  /// Get the canonical name for the \p Kind vendor.
  LLVM_TARGETPARSER_ABI static StringRef getVendorTypeName(VendorType Kind);

  /// Get the canonical name for the \p Kind operating system.
  LLVM_TARGETPARSER_ABI static StringRef getOSTypeName(OSType Kind);
  ...
  LLVM_TARGETPARSER_ABI static ArchType getArchTypeForLLVMName(StringRef Str);

  /// @}

  /// Returns a canonicalized OS version number for the specified OS.
  LLVM_TARGETPARSER_ABI static VersionTuple
