...
public:
  ...
  LLVM_DEBUGINFODWARF_ABI std::pair<uint64_t, dwarf::DwarfFormat>
  ...
  LLVM_DEBUGINFODWARF_ABI uint64_t getRelocatedValue(
      uint32_t Size, uint64_t *Off, uint64_t *SectionIndex = nullptr,
