...
public:
  ...
  LLVM_DEBUGINFODWARF_ABI static DWARFFormValue createFromSValue(dwarf::Form F,
                                                                 int64_t V);
  LLVM_DEBUGINFODWARF_ABI static DWARFFormValue createFromUValue(dwarf::Form F,
                                                                 uint64_t V);
  LLVM_DEBUGINFODWARF_ABI static DWARFFormValue createFromPValue(dwarf::Form F,
                                                                 const char *V);
  LLVM_DEBUGINFODWARF_ABI static DWARFFormValue
  createFromBlockValue(dwarf::Form F, ArrayRef<uint8_t> D);
  LLVM_DEBUGINFODWARF_ABI static DWARFFormValue
  createFromUnit(dwarf::Form F, const DWARFUnit *Unit, uint64_t *OffsetPtr);
  LLVM_DEBUGINFODWARF_ABI static std::optional<object::SectionedAddress>
  ...
  LLVM_DEBUGINFODWARF_ABI bool isFormClass(FormClass FC) const;
  const DWARFUnit *getUnit() const { return U; }
  LLVM_DEBUGINFODWARF_ABI void
  dump(raw_ostream &OS, DIDumpOptions DumpOpts = DIDumpOptions()) const;
  LLVM_DEBUGINFODWARF_ABI void
  dumpSectionedAddress(raw_ostream &OS, DIDumpOptions DumpOpts,
                       object::SectionedAddress SA) const;
  void dumpAddress(raw_ostream &OS, uint64_t Address) const;
  LLVM_DEBUGINFODWARF_ABI static void
  dumpAddress(raw_ostream &OS, uint8_t AddressSize, uint64_t Address);
  LLVM_DEBUGINFODWARF_ABI static void dumpAddressSection(const DWARFObject &Obj,
                                                         raw_ostream &OS,
  ...
  extractValue(const DWARFDataExtractor &Data, uint64_t *OffsetPtr,
  ...
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t>
  getAsSignatureReference() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t>
  getAsSupplementaryReference() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t> getAsUnsignedConstant() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<int64_t> getAsSignedConstant() const;
  LLVM_DEBUGINFODWARF_ABI Expected<const char *> getAsCString() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t> getAsAddress() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<object::SectionedAddress>
  getAsSectionedAddress() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t> getAsSectionOffset() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<ArrayRef<uint8_t>> getAsBlock() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t> getAsCStringOffset() const;
  LLVM_DEBUGINFODWARF_ABI std::optional<uint64_t> getAsReferenceUVal() const;
  ...
  LLVM_DEBUGINFODWARF_ABI std::optional<std::string>
  ...
  skipValue(dwarf::Form Form, DataExtractor DebugInfoData, uint64_t *OffsetPtr,
...
LLVM_DEBUGINFODWARF_ABI bool doesFormBelongToClass(dwarf::Form Form,
