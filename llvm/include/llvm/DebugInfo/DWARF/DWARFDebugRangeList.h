...
public:
  struct RangeListEntry {
    ...
    isBaseAddressSelectionEntry(uint8_t AddressSize) const;
  };
...
public:
  ...
  LLVM_DEBUGINFODWARF_ABI Error extract(const DWARFDataExtractor &data,
                                        uint64_t *offset_ptr);
  ...
  /// range list.
  LLVM_DEBUGINFODWARF_ABI DWARFAddressRangesVector
