...
LLVM_DEBUGINFOCODEVIEW_ABI uint32_t getScopeEndOffset(const CVSymbol &Symbol);
LLVM_DEBUGINFOCODEVIEW_ABI uint32_t
getScopeParentOffset(const CVSymbol &Symbol);

LLVM_DEBUGINFOCODEVIEW_ABI CVSymbolArray
limitSymbolArrayToScope(const CVSymbolArray &Symbols, uint32_t ScopeBegin);
