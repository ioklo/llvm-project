...
LLVM_TEXTAPI_ABI void replace_extension(SmallVectorImpl<char> &Path,
...
LLVM_TEXTAPI_ABI std::error_code shouldSkipSymLink(const Twine &Path,
                                                   bool &Result);
...
LLVM_TEXTAPI_ABI std::error_code
make_relative(StringRef From, StringRef To,
...
LLVM_TEXTAPI_ABI bool isPrivateLibrary(StringRef Path, bool IsSymLink = false);
...
LLVM_TEXTAPI_ABI llvm::Expected<llvm::Regex>
...
LLVM_TEXTAPI_ABI Expected<AliasMap>
...
LLVM_TEXTAPI_ABI PathSeq getPathsForPlatform(const PathToPlatformSeq &Paths,
