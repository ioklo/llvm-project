...
public:
  ...
  LLVM_TEXTAPI_ABI void dump(raw_ostream &OS) const;
  void dump() const { dump(llvm::errs()); }
#endif

  LLVM_TEXTAPI_ABI bool operator==(const Symbol &O) const;
...
LLVM_TEXTAPI_ABI SimpleSymbol parseSymbol(StringRef SymName);
