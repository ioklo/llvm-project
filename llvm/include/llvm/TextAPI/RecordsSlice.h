...
public:
  ...
  /// functions.
  /// \return The non-owning pointer to added record in slice.
  LLVM_TEXTAPI_ABI GlobalRecord *
  addGlobal(StringRef Name, RecordLinkage Linkage, GlobalRecord::Kind GV,
            SymbolFlags Flags = SymbolFlags::None, bool Inlined = false);
  ...
  /// \return The non-owning pointer to added record in slice.
  LLVM_TEXTAPI_ABI ObjCInterfaceRecord *
  ...
  /// \param Linkage The linkage of symbol.
  /// \return The non-owning pointer to added record in slice.
  LLVM_TEXTAPI_ABI ObjCIVarRecord *addObjCIVar(ObjCContainerRecord *Container,
                                               StringRef Name,
  ...
  /// \return The non-owning pointer to added record in slice.
  LLVM_TEXTAPI_ABI ObjCCategoryRecord *addObjCCategory(StringRef ClassToExtend,
                                                       StringRef Category);
  ...
  LLVM_TEXTAPI_ABI ObjCInterfaceRecord *findObjCInterface(StringRef Name) const;
  ...
  /// \param Category The name of category.
  /// \return The non-owning pointer to record in slice.
  LLVM_TEXTAPI_ABI ObjCCategoryRecord *
  findObjCCategory(StringRef ClassToExtend, StringRef Category) const;
  ...
  /// slice.
  LLVM_TEXTAPI_ABI ObjCContainerRecord *findContainer(bool IsIVar,
  ...
  /// \return The non-owning pointer to record in slice.
  LLVM_TEXTAPI_ABI ObjCIVarRecord *findObjCIVar(bool IsScopedName,
                                                StringRef Name) const;
  ...
  LLVM_TEXTAPI_ABI void visit(RecordVisitor &V) const;
  ...
  LLVM_TEXTAPI_ABI BinaryAttrs &getBinaryAttrs();

  /// Store any strings owned by RecordSlice into allocator and return back
  /// reference to that.
  LLVM_TEXTAPI_ABI StringRef copyString(StringRef String);
...
class InterfaceFile;
LLVM_TEXTAPI_ABI std::unique_ptr<InterfaceFile>
