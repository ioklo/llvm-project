...
public:
  ...
  LLVM_TEXTAPI_ABI void addTarget(const Target &Target);
  ...
  LLVM_TEXTAPI_ABI const_filtered_target_range
  targets(ArchitectureSet Archs) const;
  ...
  LLVM_TEXTAPI_ABI void addParentUmbrella(const Target &Target_,
                                          StringRef Parent);
  ...
  LLVM_TEXTAPI_ABI void addAllowableClient(StringRef InstallName,
                                           const Target &Target);
  ...
  /// \param Target The target triple for which this applies.
  LLVM_TEXTAPI_ABI void addReexportedLibrary(StringRef InstallName,
                                             const Target &Target);
  ...
  LLVM_TEXTAPI_ABI void addDocument(std::shared_ptr<InterfaceFile> &&Document);
  ...
  LLVM_TEXTAPI_ABI void addRPath(StringRef RPath, const Target &InputTarget);
  ...
  LLVM_TEXTAPI_ABI llvm::Expected<std::unique_ptr<InterfaceFile>>
  ...
  LLVM_TEXTAPI_ABI void inlineLibrary(std::shared_ptr<InterfaceFile> Library,
  ...
  LLVM_TEXTAPI_ABI void setFromBinaryAttrs(const RecordsSlice::BinaryAttrs &BA,
                                           const Target &Targ);
  ...
  LLVM_TEXTAPI_ABI bool operator==(const InterfaceFile &O) const;
