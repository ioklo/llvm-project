...
public:
  ...
  LLVM_OBJECT_ABI static Expected<Decompressor>
  create(StringRef Name, StringRef Data, bool IsLE, bool Is64Bit);
  ...
  LLVM_OBJECT_ABI Error decompress(MutableArrayRef<uint8_t> Output);
