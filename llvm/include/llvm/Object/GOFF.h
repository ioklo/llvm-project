...
class Record {
public:
  LLVM_OBJECT_ABI static Error
  getContinuousData(const uint8_t *Record, uint16_t DataLength, int DataIndex,
...
public:
  ...
  LLVM_OBJECT_ABI static Error getData(const uint8_t *Record,
                                       SmallString<256> &CompleteData);
