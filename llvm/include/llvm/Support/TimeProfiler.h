...
LLVM_SUPPORT_ABI bool isTimeTraceVerbose();
...
timeTraceProfilerInitialize(unsigned TimeTraceGranularity, StringRef ProcName,
...
LLVM_SUPPORT_ABI TimeTraceProfilerEntry *
...
/// for more details.
LLVM_SUPPORT_ABI TimeTraceProfilerEntry *
timeTraceAsyncProfilerBegin(StringRef Name, StringRef Detail);
...
LLVM_SUPPORT_ABI void timeTraceProfilerEnd(TimeTraceProfilerEntry *E);
