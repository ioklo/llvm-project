...
// missing symbol linker errors on windows.
      ...
      #define LLVM_SUPPORT_TEMPLATE_ABI
      #define LLVM_SUPPORT_EXPORT_TEMPLATE
      #define LLVM_SUPPORT_ABI_EXPORT
    #elif defined(_WIN32) && !defined(__MINGW32__)
      #if defined(LLVM_SUPPORT_EXPORTS)
        #define LLVM_SUPPORT_ABI __declspec(dllexport)
        #define LLVM_SUPPORT_TEMPLATE_ABI
        #define LLVM_SUPPORT_EXPORT_TEMPLATE __declspec(dllexport)
      #else
        #define LLVM_SUPPORT_ABI __declspec(dllimport)
        #define LLVM_SUPPORT_TEMPLATE_ABI __declspec(dllimport)
        #define LLVM_SUPPORT_EXPORT_TEMPLATE
      #endif
      #define LLVM_SUPPORT_ABI_EXPORT __declspec(dllexport)
    #elif defined(__ELF__) || defined(__MINGW32__) || defined(_AIX) ||             \
          defined(__MVS__)
      #define LLVM_SUPPORT_ABI LLVM_ATTRIBUTE_VISIBILITY_DEFAULT
      #define LLVM_SUPPORT_TEMPLATE_ABI LLVM_ATTRIBUTE_VISIBILITY_DEFAULT
      #define LLVM_SUPPORT_EXPORT_TEMPLATE
      #define LLVM_SUPPORT_ABI_EXPORT LLVM_ATTRIBUTE_VISIBILITY_DEFAULT
    #elif defined(__MACH__) || defined(__WASM__) || defined(__EMSCRIPTEN__)
      #define LLVM_SUPPORT_ABI LLVM_ATTRIBUTE_VISIBILITY_DEFAULT
      #define LLVM_SUPPORT_TEMPLATE_ABI
      #define LLVM_SUPPORT_EXPORT_TEMPLATE
    ...
    #define LLVM_SUPPORT_ABI_EXPORT
  #endif
  #define LLVM_SUPPORT_C_ABI LLVM_SUPPORT_ABI
#endif
