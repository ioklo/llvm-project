...
public:
  ...
  LLVM_SUPPORT_ABI explicit CleanupInstaller(StringRef Filename);
  LLVM_SUPPORT_ABI ~CleanupInstaller();
};
...
public:
  ...
  /// constructor.
  LLVM_SUPPORT_ABI ToolOutputFile(StringRef Filename, std::error_code &EC,
                                  sys::fs::OpenFlags Flags);

  LLVM_SUPPORT_ABI ToolOutputFile(StringRef Filename, int FD);
