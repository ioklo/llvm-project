...
LLVM_SUPPORT_ABI bool isFormatting(int UCS);
...
/// rules.
LLVM_SUPPORT_ABI int foldCharSimple(int C);
...
LLVM_SUPPORT_ABI std::optional<char32_t> nameToCodepointStrict(StringRef Name);
...
LLVM_SUPPORT_ABI std::optional<LooseMatchingResult>
...
LLVM_SUPPORT_ABI SmallVector<MatchForCodepointName>
