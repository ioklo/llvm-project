...
LLVM_SUPPORT_ABI bool RunningWindows8OrGreater();

/// Determines if the program is running on Windows 11 or Windows Server 2022.
LLVM_SUPPORT_ABI bool RunningWindows11OrGreater();

/// Returns the Windows version as Major.Minor.0.BuildNumber. Uses
/// RtlGetVersion or GetVersionEx under the hood depending on what is available.
/// GetVersionEx is deprecated, but this API exposes the build number which can
/// be useful for working around certain kernel bugs.
LLVM_SUPPORT_ABI llvm::VersionTuple GetWindowsOSVersion();

LLVM_SUPPORT_ABI bool MakeErrMsg(std::string *ErrMsg,
...
/// File API.
LLVM_SUPPORT_ABI std::error_code widenPath(const Twine &Path8,
