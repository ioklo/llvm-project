...
public:
  ...
  LLVM_SUPPORT_ABI StringRef getCStrRef(uint64_t *OffsetPtr,
  ...
  ///     offset plus the length of the C string is out of bounds,
  ///     a default-initialized StringRef will be returned.
  LLVM_SUPPORT_ABI StringRef getFixedLengthString(uint64_t *OffsetPtr,
  ...
  LLVM_SUPPORT_ABI StringRef getBytes(uint64_t *OffsetPtr, uint64_t Length,
                                      Error *Err = nullptr) const;
  ...
  ///     failure.
  LLVM_SUPPORT_ABI uint64_t getUnsigned(uint64_t *offset_ptr,
                                        uint32_t byte_size,
                                        Error *Err = nullptr) const;
  ...
  ///     or zero on failure.
  LLVM_SUPPORT_ABI int64_t getSigned(uint64_t *offset_ptr, uint32_t size) const;
  ...
  LLVM_SUPPORT_ABI uint8_t getU8(uint64_t *offset_ptr,
                                 Error *Err = nullptr) const;
  ...
  ///     NULL otherise.
  LLVM_SUPPORT_ABI uint8_t *getU8(uint64_t *offset_ptr, uint8_t *dst,
  ...
  LLVM_SUPPORT_ABI uint8_t *getU8(Cursor &C, uint8_t *Dst,
                                  uint32_t Count) const;
  ...
  //------------------------------------------------------------------
  LLVM_SUPPORT_ABI uint16_t getU16(uint64_t *offset_ptr,
                                   Error *Err = nullptr) const;
  ...
  ///     \a dst if all values were properly extracted and copied,
  ///     NULL otherise.
  LLVM_SUPPORT_ABI uint16_t *getU16(uint64_t *offset_ptr, uint16_t *dst,
                                    uint32_t count) const;
  ...
  LLVM_SUPPORT_ABI uint32_t getU24(uint64_t *OffsetPtr,
                                   Error *Err = nullptr) const;
  ...
  LLVM_SUPPORT_ABI uint32_t getU32(uint64_t *offset_ptr,
                                   Error *Err = nullptr) const;
  ...
  ///     \a dst if all values were properly extracted and copied,
  ///     NULL otherise.
  LLVM_SUPPORT_ABI uint32_t *getU32(uint64_t *offset_ptr, uint32_t *dst,
                                    uint32_t count) const;
  ...
  LLVM_SUPPORT_ABI uint64_t getU64(uint64_t *offset_ptr,
                                   Error *Err = nullptr) const;
  ...
  ///     \a dst if all values were properly extracted and copied,
  ///     NULL otherise.
  LLVM_SUPPORT_ABI uint64_t *getU64(uint64_t *offset_ptr, uint64_t *dst,
                                    uint32_t count) const;
  ...
  LLVM_SUPPORT_ABI int64_t getSLEB128(uint64_t *OffsetPtr,
                                      Error *Err = nullptr) const;
  ...
  LLVM_SUPPORT_ABI uint64_t getULEB128(uint64_t *offset_ptr,
  ...
  LLVM_SUPPORT_ABI void skip(Cursor &C, uint64_t Length) const;
