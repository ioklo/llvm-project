...
constexpr bool llvm_is_multithreaded() { return LLVM_ENABLE_THREADS; }
  ...
  public:
    ...
    LLVM_SUPPORT_ABI unsigned compute_thread_count() const;
    ...
    LLVM_SUPPORT_ABI void apply_thread_strategy(unsigned ThreadPoolNum) const;
  ...
  LLVM_SUPPORT_ABI std::optional<ThreadPoolStrategy>
  ...
  LLVM_SUPPORT_ABI uint32_t get_max_thread_name_length();
  ...
  LLVM_SUPPORT_ABI int get_physical_cores();
  ...
  LLVM_SUPPORT_ABI SetThreadPriorityResult
