...
public:
  ...
  LLVM_SUPPORT_ABI explicit BinaryStreamReader(BinaryStreamRef Ref);
  LLVM_SUPPORT_ABI explicit BinaryStreamReader(BinaryStream &Stream);
  LLVM_SUPPORT_ABI explicit BinaryStreamReader(ArrayRef<uint8_t> Data, llvm::endianness Endian);
  LLVM_SUPPORT_ABI explicit BinaryStreamReader(StringRef Data, llvm::endianness Endian);
  ...
  LLVM_SUPPORT_ABI Error readLongestContiguousChunk(ArrayRef<uint8_t> &Buffer);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readBytes(ArrayRef<uint8_t> &Buffer, uint32_t Size);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readULEB128(uint64_t &Dest);

  /// Read a signed LEB128 encoded value.
  ///
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readSLEB128(int64_t &Dest);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readCString(StringRef &Dest);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readWideString(ArrayRef<UTF16> &Dest);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readFixedString(StringRef &Dest, uint32_t Length);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readStreamRef(BinaryStreamRef &Ref);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readStreamRef(BinaryStreamRef &Ref, uint32_t Length);
  ...
  /// \returns a success error code if the data was successfully read, otherwise
  /// returns an appropriate error code.
  LLVM_SUPPORT_ABI Error readSubstream(BinarySubstreamRef &Ref, uint32_t Length);
  ...
  LLVM_SUPPORT_ABI Error skip(uint64_t Amount);
  ...
  LLVM_SUPPORT_ABI uint8_t peek() const;

  LLVM_SUPPORT_ABI Error padToAlignment(uint32_t Align);

  LLVM_SUPPORT_ABI std::pair<BinaryStreamReader, BinaryStreamReader>
