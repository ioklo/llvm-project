...
public:
  ...
  /// AddSymbol().
  LLVM_SUPPORT_ABI void *getAddressOfSymbol(const char *symbolName);
  ...
  LLVM_SUPPORT_ABI static DynamicLibrary
  ...
  ///
  /// It is safe to call this function multiple times for the same library.
  LLVM_SUPPORT_ABI static DynamicLibrary getLibrary(
    const char *FileName, std::string *Err = nullptr);
  ...
  /// getLibrary() function.
  LLVM_SUPPORT_ABI static void closeLibrary(DynamicLibrary &Lib);
  ...
  LLVM_SUPPORT_ABI static void AddSymbol(StringRef symbolName,
                                         void *symbolValue);
