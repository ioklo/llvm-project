...
LLVM_SUPPORT_ABI std::pair<uint64_t, int16_t> multiply64(uint64_t LHS,
                                                         uint64_t RHS);
...
LLVM_SUPPORT_ABI std::pair<uint64_t, int16_t> divide64(uint64_t Dividend,
                                                       uint64_t Divisor);
...
///
/// \pre \c Dividend and \c Divisor are non-zero.
LLVM_SUPPORT_ABI std::pair<uint32_t, int16_t> divide32(uint32_t Dividend,
                                                       uint32_t Divisor);
