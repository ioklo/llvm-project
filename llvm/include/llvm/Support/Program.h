...
namespace sys {
  ...
  LLVM_SUPPORT_ABI std::error_code ChangeStdinMode(fs::OpenFlags Flags);
  LLVM_SUPPORT_ABI std::error_code ChangeStdoutMode(fs::OpenFlags Flags);

  // These functions change the specified standard stream (stdin or stdout) to
  // binary mode. They return errc::success if the specified stream
  // was changed. Otherwise a platform dependent error is returned.
  LLVM_SUPPORT_ABI std::error_code ChangeStdinToBinary();
  LLVM_SUPPORT_ABI std::error_code ChangeStdoutToBinary();
  ...
  LLVM_SUPPORT_ABI int ExecuteAndWait(
  ...
  LLVM_SUPPORT_ABI ProcessInfo ExecuteNoWait(
  ...
  commandLineFitsWithinSystemLimits(StringRef Program,
  ...
  LLVM_SUPPORT_ABI void printArg(llvm::raw_ostream &OS, StringRef Arg,
                                 bool Quote);
  ...
  /// on
  /// Windows.
  LLVM_SUPPORT_ABI ErrorOr<std::wstring>
