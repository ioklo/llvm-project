...
public:
  ...
  LLVM_SUPPORT_ABI static Pid getProcessId();
  ...
  /// substituted instead.
  LLVM_SUPPORT_ABI static Expected<unsigned> getPageSize();
  ...
  /// allocated space.
  LLVM_SUPPORT_ABI static size_t GetMallocUsage();
  ...
  LLVM_SUPPORT_ABI static void GetTimeUsage(TimePoint<> &elapsed,
  ...
  LLVM_SUPPORT_ABI static void PreventCoreFiles();

  /// true if PreventCoreFiles has been called, false otherwise.
  LLVM_SUPPORT_ABI static bool AreCoreFilesPrevented();

  // This function returns the environment variable \arg name's value as a UTF-8
  // string. \arg Name is assumed to be in UTF-8 encoding too.
  LLVM_SUPPORT_ABI static std::optional<std::string> GetEnv(StringRef name);
  ...
  /// considered.
  LLVM_SUPPORT_ABI static std::optional<std::string>
  ...
  LLVM_SUPPORT_ABI static std::error_code FixupStandardFileDescriptors();
  ...
  LLVM_SUPPORT_ABI static std::error_code SafelyCloseFileDescriptor(int FD);

  /// This function determines if the standard input is connected directly
  /// to a user's input (keyboard probably), rather than coming from a file
  /// or pipe.
  LLVM_SUPPORT_ABI static bool StandardInIsUserInput();

  /// This function determines if the standard output is connected to a
  /// "tty" or "console" window. That is, the output would be displayed to
  /// the user rather than being put on a pipe or stored in a file.
  LLVM_SUPPORT_ABI static bool StandardOutIsDisplayed();

  /// This function determines if the standard error is connected to a
  /// "tty" or "console" window. That is, the output would be displayed to
  /// the user rather than being put on a pipe or stored in a file.
  LLVM_SUPPORT_ABI static bool StandardErrIsDisplayed();

  /// This function determines if the given file descriptor is connected to
  /// a "tty" or "console" window. That is, the output would be displayed to
  /// the user rather than being put on a pipe or stored in a file.
  LLVM_SUPPORT_ABI static bool FileDescriptorIsDisplayed(int fd);

  /// This function determines if the given file descriptor is displayd and
  /// supports colors.
  LLVM_SUPPORT_ABI static bool FileDescriptorHasColors(int fd);
  ...
  LLVM_SUPPORT_ABI static unsigned StandardOutColumns();
  ...
  /// console, or if the number of columns cannot be determined,
  /// this routine returns zero.
  LLVM_SUPPORT_ABI static unsigned StandardErrColumns();

  /// This function determines whether the terminal connected to standard
  /// output supports colors. If standard output is not connected to a
  /// terminal, this function returns false.
  LLVM_SUPPORT_ABI static bool StandardOutHasColors();

  /// This function determines whether the terminal connected to standard
  /// error supports colors. If standard error is not connected to a
  /// terminal, this function returns false.
  LLVM_SUPPORT_ABI static bool StandardErrHasColors();
  ...
  LLVM_SUPPORT_ABI static void UseANSIEscapeCodes(bool enable);

  /// Whether changing colors requires the output to be flushed.
  /// This is needed on systems that don't support escape sequences for
  /// changing colors.
  LLVM_SUPPORT_ABI static bool ColorNeedsFlush();
  ...
  LLVM_SUPPORT_ABI static const char *OutputColor(char c, bool bold, bool bg);

  /// Same as OutputColor, but only enables the bold attribute.
  LLVM_SUPPORT_ABI static const char *OutputBold(bool bg);

  /// This function returns the escape sequence to reverse forground and
  /// background colors.
  LLVM_SUPPORT_ABI static const char *OutputReverse();

  /// Resets the terminals colors, or returns an escape sequence to do so.
  LLVM_SUPPORT_ABI static const char *ResetColor();

  /// Get the result of a process wide random number generator. The
  /// generator will be automatically seeded in non-deterministic fashion.
  LLVM_SUPPORT_ABI static unsigned GetRandomNumber();
  ...
  [[noreturn]] LLVM_SUPPORT_ABI static void Exit(int RetCode,
                                                 bool NoCleanup = false);

private:
  [[noreturn]] LLVM_SUPPORT_ABI static void ExitNoCleanup(int RetCode);
};
