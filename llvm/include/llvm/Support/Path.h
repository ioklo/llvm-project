...
LLVM_SUPPORT_ABI const_iterator begin(StringRef path LLVM_LIFETIME_BOUND,
                                      Style style = Style::native);

/// Get end iterator over \a path.
/// @param path Input path.
/// @returns Iterator initialized to the end of \a path.
LLVM_SUPPORT_ABI const_iterator end(StringRef path LLVM_LIFETIME_BOUND);

/// Get reverse begin iterator over \a path.
/// @param path Input path.
/// @returns Iterator initialized with the first reverse component of \a path.
LLVM_SUPPORT_ABI reverse_iterator rbegin(StringRef path LLVM_LIFETIME_BOUND,
                                         Style style = Style::native);

/// Get reverse end iterator over \a path.
/// @param path Input path.
/// @returns Iterator initialized to the reverse end of \a path.
LLVM_SUPPORT_ABI reverse_iterator rend(StringRef path LLVM_LIFETIME_BOUND);
...
LLVM_SUPPORT_ABI void remove_filename(SmallVectorImpl<char> &path,
                                      Style style = Style::native);
...
///                  prepended.
LLVM_SUPPORT_ABI void replace_extension(SmallVectorImpl<char> &path,
...
LLVM_SUPPORT_ABI bool replace_path_prefix(SmallVectorImpl<char> &Path,
                                          StringRef OldPrefix,
                                          StringRef NewPrefix,
                                          Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef remove_leading_dotslash(
    StringRef path LLVM_LIFETIME_BOUND, Style style = Style::native);
...
LLVM_SUPPORT_ABI bool remove_dots(SmallVectorImpl<char> &path,
...
LLVM_SUPPORT_ABI void append(SmallVectorImpl<char> &path, Style style,
...
///
/// @param path A path that is transformed to native format.
LLVM_SUPPORT_ABI void native(SmallVectorImpl<char> &path,
                             Style style = Style::native);
...
/// chracters.
LLVM_SUPPORT_ABI std::string convert_to_slash(StringRef path,
                                              Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef relative_path(StringRef path LLVM_LIFETIME_BOUND,
                                         Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef parent_path(StringRef path LLVM_LIFETIME_BOUND,
                                       Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef filename(StringRef path LLVM_LIFETIME_BOUND,
                                    Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef stem(StringRef path LLVM_LIFETIME_BOUND,
                                Style style = Style::native);
...
LLVM_SUPPORT_ABI StringRef extension(StringRef path LLVM_LIFETIME_BOUND,
                                     Style style = Style::native);
...
LLVM_SUPPORT_ABI void system_temp_directory(bool erasedOnReboot,
...
LLVM_SUPPORT_ABI bool has_root_name(const Twine &path,
                                    Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_root_directory(const Twine &path,
                                         Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_root_path(const Twine &path,
                                    Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_relative_path(const Twine &path,
                                        Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_parent_path(const Twine &path,
                                      Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_filename(const Twine &path,
                                   Style style = Style::native);
...
LLVM_SUPPORT_ABI bool has_extension(const Twine &path,
                                    Style style = Style::native);
...
LLVM_SUPPORT_ABI bool is_absolute(const Twine &path,
                                  Style style = Style::native);
...
/// not.
LLVM_SUPPORT_ABI bool is_absolute_gnu(const Twine &path,
                                      Style style = Style::native);
...
LLVM_SUPPORT_ABI bool is_relative(const Twine &path,
                                  Style style = Style::native);
