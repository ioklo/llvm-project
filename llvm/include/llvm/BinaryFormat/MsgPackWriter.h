...
public:
  ...
  LLVM_BINARYFORMAT_ABI Writer(raw_ostream &OS, bool Compatible = false);
  ...
  LLVM_BINARYFORMAT_ABI void writeNil();

  /// Write a \em Boolean to the output stream.
  ///
  /// The output will be a \em bool format.
  LLVM_BINARYFORMAT_ABI void write(bool b);
  ...
  LLVM_BINARYFORMAT_ABI void write(MemoryBufferRef Buffer);
  ...
  LLVM_BINARYFORMAT_ABI void writeArraySize(uint32_t Size);
  ...
  LLVM_BINARYFORMAT_ABI void writeMapSize(uint32_t Size);
  ...
  LLVM_BINARYFORMAT_ABI void writeExt(int8_t Type, MemoryBufferRef Buffer);
